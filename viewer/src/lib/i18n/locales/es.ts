...
export default {
	...
	boundary: {
		...
		can_2:
			'Por separado, cuando se incorporan los datos electorales, el mapa minoritario se sitúa en el percentil 99.99 de 1.01 millones de mapas de comparación trazados algorítmicamente bajo las mismas reglas estatutarias. Menos de 100 de esos 1.01 millones de mapas neutrales alcanzan el mismo desequilibrio de escaños. La señal estadística combinada es de aproximadamente 1 en 14.5 millones bajo un proceso de trazado neutral. Dos instrumentos independientes — geométrico y estadístico — llegan a la misma conclusión.',
		can_3:
	...
	body: {
		...
		clean: {
			...
			t3_r1_b: '46.0%',
			t3_r1_c: 'Percentil 83 — dentro del rango normal',
			t3_r2_a: '<strong>Mayoritario 2026</strong>',
			t3_r2_b: '<strong>46.1%</strong>',
			t3_r2_c: '<strong>Percentil 83 — bien dentro de los límites</strong>',
			...
			sub3_p: 'Los shapefiles oficiales revelan un mapa estadísticamente extremo en la misma dirección partidista en las cuatro medidas a la vez. La probabilidad conjunta de que un proceso de trazado neutral produzca un mapa así de extremo en las cuatro medidas simultáneamente es de aproximadamente uno en 15 millones (p&nbsp;=&nbsp;6.87×10<sup>−8</sup>, <a href="https://osf.io/6pt83" rel="noopener">prueba combinada de Fisher preregistrada</a>). Esto no es un error de redondeo ni un artefacto de medición — es la misma respuesta de cuatro instrumentos estadísticos independientes leídos en la misma sala.',
			details_summary: 'Qué significa este valor p — y qué no',
			details_p1: 'Un valor p responde una sola pregunta: si el mapa hubiera sido trazado por un proceso neutral, ¿con qué frecuencia veríamos un resultado así de extremo o más? Con p&nbsp;=&nbsp;6.87×10<sup>−8</sup>, la respuesta es aproximadamente una vez en 14.5 millones de intentos.',
			details_p2: 'Esta es una prueba de hipótesis frecuentista, no una medición de intención. No dice que la comisión tuviera la intención de hacer un gerrymander, y no cuantifica qué tan injusto es el mapa en términos prácticos. Dice que el patrón de los límites es estadísticamente inconsistente con un proceso de trazado neutral — la misma conclusión a la que llegaría una auditoría aleatorizada sin importar quién trazó el mapa ni por qué.',
			details_p3: 'La prueba fue preregistrada antes de analizar los datos (<a href="https://osf.io/w2s8k" rel="noopener">registro OSF w2s8k</a>). El preregistro especifica de antemano la hipótesis nula, las métricas y el umbral de rechazo, de modo que el resultado no puede atribuirse a haber elegido un encuadre favorable después de ver los números.',
			...
			t5_r1_c: 'dentro del rango normal en cada métrica (<code>seats@50/50</code> 46.1% — p83; brecha de eficiencia +0.04%)',
		...
		litmus: {
			...
			table_r6_b: '46.1% — p83 (rango normal)',
