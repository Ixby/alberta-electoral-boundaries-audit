...
export default {
	...
	top_callouts: {
		...
		gerrymander_body: 'El mapa minoritario de la comisión ocurriría por azar en menos de 1 de cada 350.000 de mapas dibujados aleatoriamente. El mapa mayoritario queda cómodamente dentro del rango normal.',
		tldr_label: 'En breve',
