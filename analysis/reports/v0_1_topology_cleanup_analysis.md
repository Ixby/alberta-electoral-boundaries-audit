...
| `analysis/reports/v0_1_topology_cleanup_log.csv` | Per-ED before/after areas |
| `analysis/reports/v0_1_topology_cleanup_summary.json` | Validation gates + stats |
| `data/v0_2_phase4c_majority_2023_votes_maup.csv` | MAUP-v2 per-ED majority votes |
| `data/v0_2_phase4c_minority_2023_votes_maup.csv` | MAUP-v2 per-ED minority votes |
| `analysis/reports/phase_4c_va_to_2026_assignments_maup_v2.csv` | Per-VA attribution |
...
* Per-ED cleanup log: `analysis/reports/v0_1_topology_cleanup_log.csv`
