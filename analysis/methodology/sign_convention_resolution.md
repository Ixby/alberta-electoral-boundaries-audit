...
From `analysis/scripts/packing_cracking_analysis.py`, `compute_metrics()`, lines
131-142:
...
Data: `data/alberta_2023_results.csv`, 87 EDs, loaded by
`load_2023_results()`.
...
4. `analysis/scripts/monte_carlo_ci.py` lines 158-159 print
...
- The 2019 baseline framing of "−2.64% is Alberta's natural UCP-favourable
  ...
  Chen-Rodden `chen_rodden_alberta_validation.md` analysis assumes
...
From `data/cross_election_asymmetry_3way.csv`:
