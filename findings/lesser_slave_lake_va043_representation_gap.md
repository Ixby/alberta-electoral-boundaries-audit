...
- Whether EA applies s.112(2) as a blanket advance-vote policy or as an individual judgment for specific low-population VAs is unknown (EA response 2026-05-19 directed to Statement of Vote; per-VA SOV question not specifically addressed — FOIP remains open)
...
- Whether the commission requested or received VA-level advance vote data from EA (EA response 2026-05-19 did not address this)
- Whether EA has retained VA-level advance vote data internally in any form (EA directed to Statement of Vote but did not confirm or deny internal retention)
