...
`compute_metrics()` from `analysis/scripts/v0_2_packing_cracking_analysis.py`
is invoked for:
...
`analysis/scripts/v0_3_monte_carlo_ci.py` prints "Samples with minority more
...
Ancillary correction: audit scripts in analysis/scripts/v0_3_monte_carlo_ci.py
...
`analysis/scripts/v0_3_monte_carlo_ci.py` lines 158-159 print:
