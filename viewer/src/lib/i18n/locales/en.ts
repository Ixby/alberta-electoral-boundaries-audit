...
export default {
	...
	top_callouts: {
		...
		gerrymander_body: 'On the audit\u2019s joint partisan-bias score, the commission\u2019s minority map sits in the extreme tail of 1,010,000 algorithmically-drawn neutral comparison maps \u2014 approximately 69 of them reach its tipping-point seats@50/50 value, with a dependence-robust joint upper bound of roughly 1&nbsp;in&nbsp;568,000 under that reference distribution. The majority map falls well within normal range.',
		tldr_label: 'TL;DR',
	...
	boundary: {
		...
		can_2:
			'Separately, when election data is brought in, the minority map sits at the 99.99th percentile of 1.01 million algorithmically-drawn comparison maps matched on population balance and contiguity (the ensemble enforces those two requirements, not every statutory criterion such as communities of interest). Roughly 69 of those 1.01 million neutral maps reach the same seats@50/50 value. The dependence-robust joint upper bound across the two analytical channels is approximately 1 in 568,000 under that reference distribution (p&nbsp;≤&nbsp;1.76×10<sup>−6</sup>). Two analytical instruments — geometric and statistical — reach the same conclusion, favouring the same party; the joint bound is the dependence-aware summary of that convergence, not four independent tests reading in agreement.',
		can_3:
