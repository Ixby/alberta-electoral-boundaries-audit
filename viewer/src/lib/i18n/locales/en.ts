...
export default {
	...
	stakes: {
		...
		q3: {
			...
			body:
				"At a 50/50 provincial vote, the audit's measurements place the minority proposal at a structural extreme: fewer than 100 of the 1.01 million neutral comparison maps produce the same kind of seat imbalance. The imbalance matters because at 58 of 87 seats (a two-thirds supermajority) the governing party unlocks extraordinary procedural powers. It can waive standard notice periods and push public bills through multiple legislative stages in a single day, bypassing the deliberation checks the legislature normally relies on. Whether the minority proposal's tilt is large enough to push one party past the 58-seat threshold at vote shares <em>other</em> than 50/50 is a question this audit has not yet tested. Whether the imbalance is acceptable is a question for Albertans, not for this audit."
		},
	...
	editorial_reflect: {
		...
		region_p3:
			'What it <strong>does</strong> say: in several places on the minority proposal, rural communities are being attached as the <em>tail</em> of a district whose population centre sits in a city. Look at how the minority proposal handles Airdrie — a city of about 85,800 sliced into four districts, each one extended out into a different stretch of rural countryside. The population centre of each new district is the urban slice, not the rural tail. An MLA elected from such a district is most likely to live, campaign, and prioritise where the votes are — which means rural communities formerly represented by a dedicated rural MLA become the back half of an urban-led seat. The pattern repeats on the minority proposal in ways it does not on the majority proposal.',
		region_p4:
		...
		province_p:
			"The legislature is what you get when you sum every district's answers to the three questions above. If most districts are anchored to communities whose MLAs actually live in them, the legislature represents those communities. If most districts have rural tails attached to urban heads, the legislature represents the heads — and the tails get whatever attention is left over. Downstream of all of this comes the partisan question — which party wins a majority. One step further down comes the supermajority question — whether one party crosses 58 of 87 seats and unlocks procedural shortcuts like waiving notice periods or accelerating bills through multiple stages in a single day. At a hypothetical 50/50 provincial split, the audit's measurements place the minority proposal at a structural extreme: fewer than 100 of the 1.01 million neutral comparison maps produce the same kind of seat imbalance. Whether the imbalance pushes a party past 58 seats at the vote shares Albertans actually deliver is a question this audit has not yet directly tested; the opening questions at the top of this page are honest about the gap. Whether the answer to any of these questions matters enough to act on is, again, a question for you."
	},
	editorial_history: {
		heading: 'Context: A short history of gerrymandering',
		p1: 'The word comes from 1812. Massachusetts governor Elbridge Gerry signed off on a state-senate map whose districts had been twisted to favour his party. A Boston cartoonist looked at one of them and drew it as a salamander — wings, claws, a forked tongue. The cartoonist\'s pun, <em>Gerry-mander</em>, stuck. The shape stuck too: two centuries later, the word still means drawing electoral lines to engineer a partisan outcome.',
	...
	body: {
		...
		suggestions: {
			...
			intro:
				"This audit ran into two data problems unrelated to the commission's work, but central to how Alberta's electoral system is designed. Both are fixable.",
			advance_p1:
	...
	editorial_canada: {
		...
		p4: "The distinction matters. Effective representation allows district populations to vary, sometimes substantially, when there are good reasons — rural geographies one MLA cannot reasonably serve, communities of interest worth keeping together, minority groups whose representation a strict-equality test would dilute. The Saskatchewan Reference made the flexibility constitutional. The EBCA's 25% population variance — the rule protecting rural Alberta seats — flows directly from it.",
