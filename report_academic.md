...
A fifth dimension is the rationale-failure pattern: six of the seven contested minority redraws have cleaner options available that satisfy the statutory population and area limits while matching documented public submissions; the seventh (St. Albert-Sturgeon) has no real alternative (see §5.9.2 and `analysis/methodology/v0_1_minority_rationales_validation.md`).
...
4. **The 2019 cross-election check reverses the EG asymmetry direction** (§1.2 caveat 3, §5.2.3). *Expected:* if the boundaries are statically partisan, the partisan direction should hold across multiple recent elections. *Found:* under 2019 votes, the EG asymmetry direction is the opposite of the 2023-vote direction; under April 2026 338Canada polling input, the direction matches the 2023 direction. *Indicates:* the boundary effect is sensitive to which electorate is asked. The structural irregularities (items 1–3 above) are stable; the partisan-bias *magnitude* depends on the voter distribution it interacts with. *Bears on:* **Q2** with a sharp qualifier — the audit's directional claim is "consistent across 2020s-era voter distributions" rather than "constitutionally invariant." This is reported transparently as a feature, not concealed.

5. **One of the seven contested minority redraws (St. Albert-Sturgeon) has no defensible alternative** (§5.9.2 + `v0_1_minority_rationales_validation.md`). *Expected:* a symmetric framework should classify all contested redraws as either rationale-supported or rationale-failed. *Found:* six of seven minority redraws fail their stated rationale under the audit's symmetric framework, but the seventh — St. Albert-Sturgeon — has no real alternative consistent with the population-deviation constraint and the surrounding Edmonton-corridor geography. *Indicates:* the minority's 6/7 rationale-failure pattern is meaningfully separated from the 1/7 unavoidable case; symmetric application of the framework distinguishes "engineered redraw" from "constraint-forced redraw." This anchors the audit against the legitimate "you only count what disagrees with you" critique. *Bears on:* **Q1** (the divergences are not uniformly negative) and **Q2** (the engineered/forced ratio is itself directional evidence).
...
#### 6.2.4 Verdict on the minority 2026 proposal: exhibits a gerrymander signature on the structural lane; sub-threshold on the partisan-bias-magnitude lane
...
- **Minority 2026:** sub-threshold on the partisan-bias-magnitude lane (every Alberta-calibrated EG threshold including the MCMC-derived 4.37 %); exhibits the academic literature's gerrymander signature on the cumulative structural-and-procedural lane, by a wide margin on every structural threshold the audit applies. Whether the structural signature is sufficient to call the map a gerrymander depends on whether the reader treats partisan-bias magnitude or cumulative structural pattern as dispositive. The literature recommends the cumulative reading. The audit reports the effects; what those effects suggest about how the map was drawn is for the reader to weigh.
