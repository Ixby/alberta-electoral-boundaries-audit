...
| 6 | Lopsided Margins t-test — Wang (2016), t = 3.17 (canonical 2026-06-11) | Minority | 2.2×10⁻³ | 4.0×10⁻³ | **PASS** |
...
| 9 | Declination vs canonical ensemble (p98.79, UCP-tail — corrected sign per Amendment 10) | Minority | 1.2×10⁻² | 1.5×10⁻² | **PASS** |
...
*m = 11 independent tests. BH-adjusted p = min(p_raw × m / rank, 1). The adjusted p for each rank is the minimum of the adjusted p for the rank and all higher ranks (standard BH step-up procedure).*
