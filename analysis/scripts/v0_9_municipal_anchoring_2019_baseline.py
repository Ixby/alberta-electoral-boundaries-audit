...
**Outputs.**
  * data/v0_1_2019_municipal_anchoring.csv          (per-ED, 87 rows)
  * data/v0_1_2019_municipal_anchoring_summary.json (matches 2026 schema)

Forward:
  analysis/reports/v0_1_municipal_anchoring_analysis.md  (verdict section)
Backward:
...
OUT_CSV     = DATA / "v0_1_2019_municipal_anchoring.csv"
OUT_SUMMARY = DATA / "v0_1_2019_municipal_anchoring_summary.json"
    ...
    summary = {
        "method": {
            ...
            "parity_note": (
                ...
                "v0_1_municipal_anchoring_analysis.md. USE_DA_SUPPLEMENT=False."
            ),
        },
        "sources": {
            "input": {
        ...
        "comparison_to_2026": {
            ...
            "_2026_headline_source": "analysis/reports/v0_1_municipal_anchoring_analysis.md",
        },
        "outputs": {
            "log_csv": str(OUT_CSV),
