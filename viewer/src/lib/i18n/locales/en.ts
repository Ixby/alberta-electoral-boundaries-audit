...
export default {
	...
	body: {
		...
		structural_results: {
			...
			body: 'The majority map crosses <strong>zero of five</strong> pre-registered structural thresholds. The minority map crosses <strong>all five</strong>. These are geometric measurements — population spread, <abbr title="how closely a district\'s borders follow pre-existing city and municipal limits, rather than cutting through them">municipal anchoring</abbr>, Airdrie split count, NW Calgary population excess, and chair-flagged boundary anomalies — that require no election data and no statistical sampler. The next section tests both maps against 1,010,000 computer-generated neutral maps and reaches the same conclusion through a completely different instrument.'
		},
		november: {
			heading: '7: What Happens in November',
