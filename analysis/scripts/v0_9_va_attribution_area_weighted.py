...
used by `phase_4c_va_attribution.py` and `mcmc_ensemble.score_exogenous_map`.
...
Forward
-------
analysis/reports/v0_9_maup_centroid_sensitivity.md  (verdict memo)
...
def area_weighted_attribution(
    ...
    # centroid pipeline's nearest_ed fallback in phase_4c_va_attribution.py).
