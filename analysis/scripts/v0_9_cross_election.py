...
For each election year:
  ...
  - 2019: ED-level totals from `v0_1_alberta_2019_results.csv` projected
  ...
  - 2015: ED-level 2015 totals from `v0_1_alberta_2015_results.csv`
    re-attributed to 2019 boundaries via `v0_1_2015_to_2019_crosswalk.csv`
...
Outputs
-------
  data/v0_9_cross_election_per_map.csv
  data/v0_9_cross_election_per_map.json

Forward:  analysis/reports/v0_9_cross_election_robustness.md
Backward:
