...
justification tests from `analysis/reports/justification_tests_findings.md`
...
Consolidated output: **`data/alberta_population_plan_b.csv`**. Columns
...
Regional Dashboard / TBF values from `data/alberta_population_plan_b.csv`.
...
`data/majority_2026_populations.csv` and
`data/minority_2026_populations.csv` are 2024 values. The audit's A1
...
> `analysis/reports/plan_b_cross_check.md` and the consolidated population
> table is in `data/alberta_population_plan_b.csv`.
>
...
- Plan B consolidated table: `data/alberta_population_plan_b.csv`
