"""
v0_9_airdrie_quadrant_anchoring.py — Airdrie quadrant teardown
==============================================================
...
(commit 6a39960, `v0_9_natural_anchoring_secondary_check.md`) confirms that
...
CLI:
    python analysis/scripts/v0_9_airdrie_quadrant_anchoring.py

Outputs:
    data/v0_9_airdrie_quadrant_anchoring.csv
    data/maps/airdrie_4way_teardown.png

Forward:
    analysis/reports/v0_9_airdrie_highway_pretext.md
Backward:
...
OUT_CSV = DATA / "v0_9_airdrie_quadrant_anchoring.csv"
...
def render_teardown(
    ...
    fig.text(
        ...
        "Metrics: data/v0_9_airdrie_quadrant_anchoring.csv.",
