...
From `analysis/scripts/v0_2_packing_cracking_analysis.py`, `compute_metrics()`, lines
131-142:
...
4. `analysis/scripts/v0_3_monte_carlo_ci.py` lines 158-159 print
...
5. The Track Z analysis (`analysis/reports/v0_1_2015_cross_election_analysis.md`)
