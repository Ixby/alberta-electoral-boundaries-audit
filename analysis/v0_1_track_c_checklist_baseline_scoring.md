...
backward_dependencies:
  - analysis/v0_2_packing_cracking_analysis.py (B1–B6 partisan metrics)
  - analysis/electoral_forensics_population.py (A1–A3 population findings)
  - analysis/v0_1_justification_tests_findings.md (population-math verdicts)
  - analysis/submission_search_findings.md (public-support tiers)
  - analysis/v0_1_minority_rationales_validation.md (rationale verdicts)
  - analysis/v0_1_chair_recommendation_5_analysis.md (R5 conditions as extra gates)
---
...
**Score.** Majority: strong signal NOT detected. Minority: strong signal detected (by definition — minority is where they were originally identified). Sources: `analysis/electoral_forensics_population.py` (Calgary zone gap); `analysis/v0_1_section_C_geographic_coherence.md` (Airdrie partition, RMH-Banff Park shape).
...
**Score.** Neither map introduces new signatures beyond S1's set. Source: spatial audit in `analysis/v0_1_section_C_geographic_coherence.md` and `analysis/v0_1_uncertainty_and_shapefile_impact.md`.
...
**Score.** Neither 2026 map crosses the US threshold. Source: `analysis/v0_2_packing_cracking_analysis.py`, re-verified 2026-04-22 in Gate G0.
...
**Score.** **Blocked** for both 2026 maps. The MCMC ensemble requires 2026 shapefiles, which Elections Alberta has not released for either proposal. Documented in `analysis/v0_1_uncertainty_and_shapefile_impact.md`. When shapefiles become available, Phase 5 of the v1.2 pipeline runs GerryChain and produces the percentile rank for both maps.
...
Source: `analysis/v0_1_cochrane_journey_to_work.md`.
...
**Score.** R5(a)–(d) are specifically triggered only when the 91-seat fallback is activated. Both 89-seat maps predate that trigger. Deferred to the November map. Source: `analysis/v0_1_chair_recommendation_5_analysis.md`.
...
| Five population-math justifications | N/A (majority does not invoke them) | **All five FAIL** (`analysis/v0_1_justification_tests_findings.md`) |
| Piikani / Peigan naming | N/A | Naming observation, no fault finding |

**Score.** Minority: three rationales contradicted or unsupported, five population-math tests failed. Majority: no tested rationales triggered a contradiction. Source: `analysis/v0_1_minority_rationales_validation.md`.
...
**Score.** The minority-vs-majority asymmetry is **1 seat NDP under both inputs**. The boundary effect is a structural property of the map. Source: `analysis/v0_1_338canada_riding_level.md`.
...
- Metrics source: `analysis/v0_2_packing_cracking_analysis.py` (B2, B3, B4, B6); `analysis/electoral_forensics_population.py` (A1, A2, A3).
- Public-support tiers: `analysis/submission_search_findings.md` + `analysis/v0_1_claim_significance_analysis.md`.
- Rationale checks: `analysis/v0_1_minority_rationales_validation.md`.
- Chair R5 conditions: `analysis/v0_1_chair_recommendation_5_analysis.md`.
- 338 validation: `analysis/v0_1_338canada_riding_level.md`.
- Cochrane commute: `analysis/v0_1_cochrane_journey_to_work.md`.
