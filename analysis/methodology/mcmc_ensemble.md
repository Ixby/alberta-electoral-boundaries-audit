...
- **Samples CSV:** `data/simulated_ensemble_raw_samples.csv` (10,000 rows, seven columns including UCP-seats and vote-share)
- **Percentile summary CSV:** `data/simulated_ensemble_percentiles.csv`
- **Real-map scores JSON:** `data/simulation_real_map_scores.json`
