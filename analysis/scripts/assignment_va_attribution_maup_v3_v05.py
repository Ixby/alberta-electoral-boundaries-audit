...
=================================================================
Same pipeline as v0_1_assignment_va_attribution_maup_v2.py, but points at the
...
Backward:
  ...
  analysis/scripts/v0_1_assignment_va_attribution_maup_v2.py
  data/v0_5_canonical_majority_2026_eds_da_anchored.gpkg
  data/v0_5_canonical_minority_2026_eds_da_anchored.gpkg
"""
...
OUT_MAJ = DATA / "votes_2023_majority_maup.csv"
OUT_MIN = DATA / "votes_2023_minority_maup.csv"
OUT_PER_VA = ANALYSIS / "reports" / "phase4c_va_to_2026_assignments_maup.csv"
OUT_SUMMARY = ANALYSIS / "reports" / "phase4c_maup_summary.json"
...
def main():
    ...
    for label, v05_path, v02_path in [
        ("majority", OUT_MAJ, DATA / "v0_2_votes_2023_majority_maup.csv"),
        ("minority", OUT_MIN, DATA / "v0_2_votes_2023_minority_maup.csv"),
    ]:
        try:
