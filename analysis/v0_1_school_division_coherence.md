...
- `analysis/v0_1_minority_rationales_inventory.md` (R1–R25 inventory).
- `analysis/v0_1_minority_rationales_validation.md` (Track I verdicts).
- `analysis/v0_1_section_C_geographic_coherence.md` (§C4 school-division gap note, now filled).
