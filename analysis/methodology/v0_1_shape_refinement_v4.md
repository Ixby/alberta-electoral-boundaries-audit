...
backward_dependencies:
  - analysis/methodology/v0_1_commission_reference_shapes.md (documents the v3 mismatches this pass addresses)
  - analysis/methodology/v0_1_shape_refinement_v3.md (the superseded Tier B approximation)
...
`analysis/methodology/v0_1_commission_reference_shapes.md` as "unquantifiable
