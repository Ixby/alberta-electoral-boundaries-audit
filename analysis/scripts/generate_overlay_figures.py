"""
v0_1_generate_overlay_figures.py
...
Data sources (same as v1)
  ...
  - data/majority_full_crosswalk.csv                    (88-row name map)
  - data/minority_full_crosswalk.csv                    (88-row name map)
...
PATH_MAJ_XWALK = DATA / "majority_full_crosswalk.csv"
PATH_MIN_XWALK = DATA / "minority_full_crosswalk.csv"
