...
| **DA-anchored** (v0_5) | `v0_5_canonical_majority_2026_eds_da_anchored.gpkg` / `v0_5_canonical_minority_2026_eds_da_anchored.gpkg` | Further snapped to Dissemination Area boundaries by `da_boundary_anchoring.py`, enabling precise population attribution. |
| **Boundary-propagated** (v0_6) | `v0_6_canonical_majority_2026_eds_propagated.gpkg` / `v0_6_canonical_minority_2026_eds_propagated.gpkg` | Population-weighted boundary propagation applied by `boundary_propagation.py`. **These are the final canonical shapefiles used in all analysis.** |
