...
- **Courtney, John C. 2001.** *Commissioned Ridings: Designing Canada's Electoral Districts*. Montreal and Kingston: McGill-Queen's University Press. — **the foundational Canadian work on boundary commissions.** Covers the independent-commission model, its development, and the range of practice across provinces. Every claim in §D about Canadian norms should reference this with chapter/page pincites, not as a general authority. **Critical omission.**
