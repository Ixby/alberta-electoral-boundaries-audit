...
forward_dependencies:
  - analysis/methodology/v0_1_methodological_defenses.md §1.1 "The Advance Vote Black Hole" — quantified-insignificance line for insertion
...
backward_dependencies:
  ...
  - analysis/scripts/v0_9_advance_vote_sensitivity.py — re-scores v0_9 maps under both substrates
  ...
  - data/v0_9_advance_vote_sensitivity.json — full output
---
