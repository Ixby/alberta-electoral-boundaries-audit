...
* **Status (canonical, 2026-05-12; updated 2026-07-12):** Lane 1 is NOT demoted on the 1M canonical ensemble. The canonical run places the minority at MM p99.97, s50 p99.99, and Mahalanobis joint p = 8.80×10⁻⁷. The uniform-swing sensitivity is reported as a limitation (academic report §5.5), but Lane 1 contributes independently alongside Lane 2. Regional-swing recomputation against the canonical 1M ensemble is a blocker (see task list). Pre-canonical conclusion preserved for record. Note: numbers reflect the 2026-07-12 clean rerun after fixing ensemble chain defects. 

### 3.2 The "One-Metric Gerrymander" & Microtargeting (Efficiency Gap Immunity)

> **Canonical update (2026-05-12; updated 2026-07-12):** Pre-canonical values below are stale. Canonical 1M (post-2026-07-12 clean rerun): EG p94.4 (unflagged), MM p99.97 (flagged), Decl p98.79 UCP-tail (flagged), s50 p99.99 (flagged). Three metrics individually flag; EG does not. Mahalanobis D = 5.80, p = 8.80×10⁻⁷. "One-metric" framing no longer applies. Pre-canonical text preserved for record. **[Amendment 10, 2026-06-12 — declination sign corrected.** The "p1.21 / NDP-tail / disagrees-with-EG" reading here used the swapped-operand convention (δ_audit = −δ_Warrington), a code-side artefact at `mcmc_ensemble.py:215`, now retired. Under the corrected Warrington convention the minority's declination is +0.077, **p98.79, UCP-tail** — it AGREES with EG, mean-median, and seats@50/50 (four of four in the UCP-favoured direction). The text here is preserved as the pre-correction record. See `reports/academic/report_academic.md` §5.4.9 and Amendment 10 in `findings/pre_registration_amendment_log.md`.**]**
