---
name: v0_9_cross_election_robustness
...
## Data and reproduction
  ...
  - Per-map per-year metrics: `data/v0_9_cross_election_per_map.csv` (6 rows: 2 maps × 3 elections) and `.json`.
  - Script: `analysis/scripts/v0_9_cross_election.py`.
