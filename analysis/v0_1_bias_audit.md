...
**Finding.** `analysis/electoral_forensics_population.py` defines:
...
**Finding.** `v0_1_section_A_population_equality.md` opens:
...
**Finding.** For minority hybrids (Nolan Hill-Cochrane, RMH-Banff Park, Olds-Three Hills-Didsbury, Foothills-Airdrie West), `v0_1_section_C_geographic_coherence.md` asks: does this ED show a lasso, an engineered statutory boundary, a misnamed municipality capture?
...
**Finding.** `v0_1_section_4_geometry_provenance.md` (and the migration and v0.9 prompt) state:
