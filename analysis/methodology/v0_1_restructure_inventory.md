...
| Filename | Purpose | Incoming refs |
|---|---|---|
| v0_1_pre_registration_draft.md | Formal pre-registration protocol | 33 |
| v0_1_consistency_audit.md | Consistency audit of applied-vs-stated methods | 29 |
| v0_1_track_c_checklist_baseline_scoring.md | Track C compliance-checklist baseline scores | 27 |
| v0_1_chair_recommendation_5_analysis.md | Analysis of Chair Recommendation #5 implications | 18 |
| v0_1_plan_b_cross_check.md | Cross-check of alternative boundary plan (Plan B) | 16 |
| submission_search_findings.md | Key findings from submission-document search | 7 |
| v0_1_2015_cross_election_analysis.md | Cross-election comparison findings (2015 vs 2019) | 6 |
| v0_1_airdrie_overlap_report.md | Airdrie boundary-overlap incident findings | 6 |
| v0_1_marginal_seats_findings.md | Swing-seat vulnerability report | 5 |
| v0_1_rural_gap_findings.md | Rural-urban voting-gap analysis findings | 4 |
| v0_1_justification_tests_findings.md | Results of statistical validation tests | 4 |
| v0_1_claim_significance_analysis.md | Statistical significance of key audit claims | 3 |
| v0_1_91_seat_preliminary.md | Preliminary analysis of 91-seat proposal | 3 |
| v0_1_bias_audit.md | Partisan-bias detection findings | 3 |
| phase_4c_gerrymander_comparison.md | Phase 4C gerrymandering-metric comparison | 2 |
| v0_1_design_critique.md | Design critique of electoral-division structure | 2 |
| v0_1_byelection_assessment.md | By-election impact assessment | 2 |
| v0_1_act_amendment_proposal.md | Proposed amendments to Electoral Divisions Act | 2 |
| v0_1_ai_use_recommendations_for_committee.md | Recommendations for AI use in committee deliberations | 2 |
| v0_1_pre_registration_amendment_2026-04-23.md | Amendment to pre-registration protocol (dated) | 1 |
| v0_1_pre_registration_platform_analysis.md | Analysis of pre-registration implementation platform | 1 |
| va_spatial_integrity_report.md | Voting-area spatial-data integrity assessment | 0 |
| v0_1_article_figures_v3.md | Figure captions and methodology for article (v3) | 0 |
| v0_1_approximate_shape_analysis.md | Geometric-analysis narrative for approximate proposals | 0 |
| v0_1_vote_anywhere_report.md | Mobile/advance-voting impact assessment | 0 |
| v0_1_section_A_population_equality.md | Report section: population-equality audit | 0 |
| v0_1_section_C_geographic_coherence.md | Report section: geographic-coherence audit | 0 |
| v0_1_section_D_procedural.md | Report section: procedural-compliance audit | 0 |
| v0_1_section_4_geometry_provenance.md | Report section: shapefile-source provenance | 0 |
| v0_1_terms_of_reference_audit.md | Audit against commission's stated terms of reference | 0 |
| v0_1_chen_rodden_decomposition.md | Geography-vs-drawing decomposition results writeup | 11 |
...
| v0_1_mcmc_ensemble.md | MCMC ensemble methodology and results narrative | 101 |
| v0_1_shape_refinement.md | Master shapefile-refinement methodology | 140 |
| v0_1_mcmc_100k_and_full_coverage.md | MCMC 100k run + full-coverage rescore narrative | 18 |
| v0_1_s15_2_reaudit.md | Section 15.2 re-audit methodology and findings | 18 |
| v0_1_science_red_team_design_and_stats.md | Red-team critique of study design and statistics | 15 |
| v0_1_canadian_base_rate_computed.md | Canadian baseline computation methodology | 15 |
| v0_1_appendix_c_legal_baseline.md | Legal-baseline appendix (Appendix C) | 12 |
| v0_1_338canada_riding_level.md | 338Canada riding-level data documentation | 12 |
| v0_1_science_red_team_data_priorart_peerreview.md | Red-team critique of data sources and prior art | 11 |
| v0_1_data_preparation.md | Data-preparation methodology and pipelines | 11 |
| v0_1_sign_convention_resolution.md | Resolution of sign-convention issues | 10 |
| v0_1_shape_refinement_v4.md | Shapefile refinement v4 methodology | 10 |
| v0_1_overlay_figures_v2.md | Boundary-overlay figure-generation v2 narrative | 9 |
| v0_1_majority_symmetry_counter_test.md | Partisan-symmetry test counter-case narrative | 9 |
| v0_1_science_red_team_reproducibility_and_falsifiability.md | Red-team critique of reproducibility framework | 9 |
| v0_1_alberta_government_databases_survey.md | Survey of available Alberta government databases | 9 |
| v0_1_338canada_historical.md | 338Canada historical-polling archive documentation | 9 |
| v0_1_csd_community_splits.md | Community-split analysis via school divisions | 9 |
| v0_1_canonical_shapefile_log.md | Canonical-shapefile build log and QA | 8 |
| v0_1_canonical_shapefile_methodology.md | Canonical-shapefile construction methodology | 8 |
| v0_1_chen_rodden_alberta_validation.md | Validation of Chen-Rodden metric for Alberta | 8 |
| v0_1_commission_source_provenance.md | Commission reference-data source-provenance audit | 8 |
| v0_1_commission_reference_shapes.md | Commission-provided reference-shapefile documentation | 8 |
| v0_1_boundary_transcription.md | Manual-boundary digitization methodology | 8 |
...
| v0_1_phase_4c_execution_log.md | Phase 4C execution log and notes | 7 |
| v0_1_composite_shapefiles_log.md | Composite-shapefile compilation log | 6 |
| v0_1_build_overlay_figures.md | Overlay-figure generation methodology | 6 |
| v0_1_academic_literature_review.md | Academic literature review on gerrymandering | 5 |
| v0_1_shape_refinement_v2.md | Shapefile refinement v2 methodology | 5 |
| v0_1_shape_refinement_v3.md | Shapefile refinement v3 methodology | 4 |
| v0_1_shape_refinement_v5.md | Shapefile refinement v5 methodology | 4 |
| v0_1_shapefile_redteam_report.md | Red-team critique specific to shapefiles | 4 |
| phase_4c_runbook.md | Phase 4C step-by-step runbook for execution | 3 |
| v0_1_cochrane_journey_to_work.md | Cochrane geography / journey-to-work analysis | 3 |
| v0_1_calgary_data_sources_audit.md | Calgary-specific data-source audit | 3 |
| v0_1_minority_rationales_validation.md | Validation of minority-scenario justifications | 3 |
| v0_1_minority_rationales_inventory.md | Inventory of minority-scenario design rationales | 3 |
| v0_1_terms_of_reference_verbatim.md | Commission's terms of reference (verbatim copy) | 2 |
| v0_1_school_division_coherence.md | School-division geographic-coherence analysis | 2 |
| v0_1_uncertainty_and_shapefile_impact.md | Uncertainty quantification and sensitivity analysis | 1 |
| v0_1_threshold_provenance.md | Population-threshold documentation | 1 |
| v0_1_urban_weight_defense.md | Defense of urban-weighting methodology | 1 |
| v0_1_reproducibility_verification.md | Reproducibility-verification checklist | 1 |
| v0_1_editorial_pass_log.md | Editorial-review log | 0 |
| v0_1_tier_c_pixel_audit.md | Tier C pixel-level boundary audit | 0 |
| v0_1_338canada_integration.md | 338Canada data-integration methodology | 0 |
| v0_1_restructure_inventory.md | This file — permanent record of the restructure decisions | 0 |
...
|---|---|---|---|
| v0_1_master_plan.md | **methodology/** | reports/ | Functions as audit-framework/timeline; master-plan meta-doc. |
| v0_1_plan_b_cross_check.md | **reports/** | methodology/ | Presents findings first (cross-check results); method is secondary. |
...
2. `v0_1_article_figures_v3.md` (reports)
3. `v0_1_approximate_shape_analysis.md` (reports)
4. `v0_1_vote_anywhere_report.md` (reports)
5. `v0_1_section_A_population_equality.md` (reports)
6. `v0_1_section_C_geographic_coherence.md` (reports)
7. `v0_1_section_D_procedural.md` (reports)
8. `v0_1_section_4_geometry_provenance.md` (reports)
9. `v0_1_terms_of_reference_audit.md` (reports)
10. `v0_1_editorial_pass_log.md` (methodology)
11. `v0_1_tier_c_pixel_audit.md` (methodology)
12. `v0_1_338canada_integration.md` (methodology)
