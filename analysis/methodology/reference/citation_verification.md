...
## 2026-06-13 Update — T6.1 Status Pass

**Scope.** Checked all nine T6.1 items from the referee's legal-citation pass against the current `reports/academic/report_academic.md`. Read-only pass; no edits made to the report. Method: line-specific grep + Read against the current file.

### Status table

| # | T6.1 item | Status | Detail |
|---|---|---|---|
| 1 | *Canada National Parks Act* — should be S.C. 2000, c. 32 (not R.S.C. 1985, c. N-14) | **STILL WRONG** | Inline citation at line 2256 reads `R.S.C. 1985, c. N-14`. Not listed in the Statutes section (which contains only the EBCA). Correct form per T6.1 is `S.C. 2000, c. 32` — pending CanLII/counsel confirmation before editing. |
| 2 | *Electoral Boundaries Readjustment Act* (EBRA) — should be R.S.C. 1985, 2nd Supp., c. E-3 (not S.C. 1985, c. E-3.3) | **STILL WRONG** | Inline citation at line 1998 reads `S.C. 1985, c. E-3.3`. Not listed in the Statutes section. Correct form per T6.1 is `R.S.C. 1985, 2nd Supp., c. E-3` — pending CanLII/counsel confirmation before editing. |
| 3 | EBCA s.14(1)(a) characterises census scheme as "decennial" — it is quinquennial | **NOT FOUND AS STATED / UNRESOLVED** | The task described this as `s.14(1)(a)` calling the census "decennial" — but `s.14(1)(a)` does not appear anywhere in `report_academic.md`. The word "decennial" does appear at lines 382, 690, and 692 in connection with `§12(3)` of the Alberta EBCA (where it is presented as a direct statutory quotation: "the population information as provided in the decennial census"). The quinquennial error would be a different claim: the federal EBRA triggers on the decennial census; Statistics Canada also conducts a quinquennial census. Whether the Alberta EBCA §12(3) uses the word "decennial" or not requires checking the King's Printer PDF (URL: https://www.qp.alberta.ca/documents/Acts/E03.pdf). **Do not characterise the "decennial census" language as wrong until the Act's actual §12(3) text is confirmed.** Queue for counsel/CanLII verification: does Alberta EBCA §12(3) exist, and if so does it use "decennial"? |
| 4 | *Cassista v. Canada*, 2014 FC 398 — verify whether present and whether verified or removed | **FLAGGED, NOT REMOVED** | Present in the reference list at line 2790 with a PENDING VERIFICATION banner reading: "PENDING VERIFICATION 2026-06-12 per T1.7 R2 Ref #8 — the case was not located in CanLII or Elections Canada's court-cases index in the referee's check. Not relied upon for any verdict-bearing claim pending counsel review." Also present in the body at line 322 with the same verification flag. The citation has not been removed, but has been quarantined from all verdict-bearing claims. Substitute candidates are listed: *Dixon v. British Columbia (AG)* (1989) 59 DLR (4th) 247 (BCSC); *Reference re Electoral Divisions Statutes Amendment Act* (1994) 119 DLR (4th) 1 (Alta CA). Still requires counsel verification. |
| 5 | *Saskatchewan Reference* pinpoints — para. 26 / 33 / 98 anachronistic in SCR-format | **MIXED** | Para. 26: PRESENT at line 3082 ("McLachlin J ... wrote the guarantee of §3 is 'the right to effective representation' (para. 26)"). Para. 33: PRESENT at lines 318, 320, and 3082. Para. 98: NOT FOUND anywhere in the document. The report uses SCR-format citation ([1991] 2 SCR 158) throughout; whether para. 26 and para. 33 are anachronistic for that reporter format is a question for counsel to confirm, as SCR reporters do not number paragraphs in pre-1990s decisions. |
| 6 | Pal & Choudhry 2011 in *Democratizing the Constitution* — 2011 book is by Aucoin/Jarvis/Turnbull, not Choudhry | **STILL WRONG** | Reference entry at line 2766 reads: `Pal, Michael, and Sujit Choudhry. 2011. "Democratic Accountability and Judicial Role in Canada's Electoral System." In *Democratizing the Constitution: The Role of the People and Social Movements in Constitutional Reform*, eds. Sujit Choudhry, 95–127. Oxford: Oxford University Press.` The T6.1 concern is that *Democratizing the Constitution* is an Aucoin/Jarvis/Turnbull 2011 book, not a Choudhry-edited volume. Requires CanLII/library verification: (a) does this chapter by Pal and Choudhry exist in a Choudhry-edited Oxford volume under this title, or (b) was the volume editor and/or title incorrectly assigned? The entry as it stands credits Choudhry as both co-author and editor of the same collection, which is unusual and flags a possible conflation. Queue for counsel/library verification. |
| 7 | Cannon et al. — should be 2023, MCAP 25(36) (not 2022) | **REFERENCE FIXED / IN-TEXT STILL WRONG** | The reference-list entry at line 2730 correctly reads 2023, *Methodology and Computing in Applied Probability* 25(36), with a parenthetical noting the arXiv preprint is 2022:2011.02288. However, in-text author-date cites continue to say 2022 at: line 328 ("Cannon, Goldbloom-Helzner, Gupta, Matthews, and Suwal (2022)"), line 1558 (section heading "Cannon et al. 2022"), line 1562 ("Cannon, Goldbloom-Helzner, Gupta, Matthews, and Suwal (2022)"), line 1568 ("Cannon et al. short-bursts result"), line 2522 ("Cannon et al. (2022)"), and line 2561 ("Cannon et al. (2022)"). All in-text citations must be updated from 2022 to 2023 to match the reference list. |
| 8 | Katz, King & Rosenblatt 2020 — overclaim "explicitly recommend ensemble reporting" should be softened | **SOFTENED BUT RESIDUAL OVERCLAIM** | "Explicitly recommend" phrasing is gone. But lines 312 and 505 still say "recommend ensemble reporting" / "recommend ensemble approaches" — the May 2026 verification note (citation_verification.md Step 2, row for line 31) called this "a little too strong" and proposed the rephrasing "supports separating fairness quantities from metrics and using multiple perspectives/diagnostics." The 2026-06-12 T6.1 target was to remove any claim the paper "explicitly recommend[s] ensemble reporting"; the word "explicitly" is gone but "recommend" remains. Whether the residual "recommend" still overclaims the paper's actual argument is for the editorial/counsel pass to assess against the source. |
| 9 | *Saskatchewan Reference** asterisks — find/replace cleanup | **STILL PRESENT** | Stray double-asterisk in the italic-case-name markup (`*Saskatchewan Reference**`) is present at three locations: line 2211 ("standard from *Saskatchewan Reference** [1991]"), line 2362 ("interpretation of *Saskatchewan Reference** [1991]"), and line 3065 ("under *Saskatchewan Reference** [1991] 2 SCR 158's"). Three additional lines (238, 306, 308, 310, 316, 318, 320, 326, 599, 1996, 2201, 2453, 2671, 3088) matched the grep for `Saskatchewan Reference\*` but were "omitted long matching lines" in the context tool; the three confirmed asterisk instances above are at lines 2211, 2362, and 3065. A global find-and-replace of `*Saskatchewan Reference**` → `*Saskatchewan Reference*` is needed throughout the document. |

### Items confirmed fixed

None of the 9 items is fully resolved. Items 4 (Cassista) is partially mitigated (quarantined, not verified); item 7 (Cannon year) is half-fixed (reference correct, in-text wrong); item 8 (Katz overclaim) is softened but not fully resolved.

### Remaining for T6.1 counsel/editorial pass

| Priority | Item | Action required |
|---|---|---|
| HIGH | **#1 — National Parks Act** | Counsel confirms `S.C. 2000, c. 32` against CanLII, then update inline at line 2256. |
| HIGH | **#2 — EBRA** | Counsel confirms `R.S.C. 1985, 2nd Supp., c. E-3` against CanLII, then update inline at line 1998. |
| HIGH | **#4 — Cassista** | Independent CanLII verification of `2014 FC 398`; either confirm and remove the banner, or replace with *Dixon* or *Reference re Electoral Divisions Statutes Amendment Act*. |
| HIGH | **#6 — Pal & Choudhry 2011 / Democratizing the Constitution** | Library check: (a) does this chapter exist in a Choudhry-edited Oxford volume under this title, or (b) is the volume Aucoin/Jarvis/Turnbull 2011? Correct editor/title accordingly. |
| MEDIUM | **#3 — "decennial" in EBCA §12(3)** | Check King's Printer PDF (`qp.alberta.ca/documents/Acts/E03.pdf`) §12(3): if the Act says "decennial," the quote is accurate and the item is closed; if it says "census" or "most recent census" without "decennial," correct the report. Also confirm whether §12(3) and §12(5) exist as numbered in the report. |
| MEDIUM | **#5 — Saskatchewan Reference para. 26/33** | Counsel to confirm whether para. 26 and para. 33 are locatable in the SCR reporter (paragraphs were not numbered in 1991 SCR format); either verify the pinpoints against the original judgment or convert to page pinpoints. Para. 98 is not found and should be removed. |
| MEDIUM | **#7 — Cannon in-text year** | Editorial fix only: change all in-text "Cannon et al. (2022)" / "Cannon, Goldbloom-Helzner, Gupta, Matthews, and Suwal (2022)" and the §5.4.8 heading to 2023. Lines: 328, 1558, 1562, 1568, 2522, 2561. The parenthetical at line 2730 already explains the arXiv preprint is 2022. |
| MEDIUM | **#8 — Katz "recommend"** | Editorial assessment: does "recommend ensemble reporting/approaches" overstate the paper's argument? Source text: APSR 114(1):164–178. If yes, rephrase per May 2026 proposed wording: "supports separating fairness quantities from metrics and using multiple perspectives/diagnostics." |
| LOW | **#9 — Saskatchewan Reference asterisks** | Find-and-replace `*Saskatchewan Reference**` → `*Saskatchewan Reference*` throughout `report_academic.md`. Confirmed at lines 2211, 2362, 3065; global replace catches any further instances. |
