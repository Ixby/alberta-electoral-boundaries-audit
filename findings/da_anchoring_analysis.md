...
**Outputs:** `data/v0_5_canonical_{majority,minority}_2026_eds_da_anchored.gpkg`; per-ED log at `analysis/reports/da_anchoring_log.csv`; summary at `data/v0_1_da_anchoring_summary.json`.
**Date:** 2026-04-24.
...
| `analysis/reports/da_anchoring_log.csv` | 26 KB | Per-ED DA-anchoring log (178 rows) |
| `data/v0_1_da_anchoring_summary.json` | 5.1 KB | Summary statistics |
| `analysis/reports/da_anchoring_analysis.md` | this file | Writeup |
