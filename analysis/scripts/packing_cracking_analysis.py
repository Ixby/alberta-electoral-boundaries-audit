...
# ---------------------------------------------------------------------
# Legacy crosswalk dicts — exported for 338canada_reallocate.py and
# 338canada_historical.py. NOT used in the Phase 4C spatial attribution
# pipeline; here only for backward compatibility (removed in 478b856,
# restored 2026-06-14 when those scripts failed on import).
# ---------------------------------------------------------------------
