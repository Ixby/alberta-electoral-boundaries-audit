...
| 41 | EG Alberta historical-swing threshold | 5–9 % (provisional) | §5.2.8 Option C | **FP / OBS** | Pending Issue #16; provisional from Alberta two-party competitiveness; requires computing EG under prior-cycle boundaries |

Counts by provenance class: **STAT**: 6 · **LIT**: 6 · **FP**: 16 · **MOD**: 6 · **AUD**: 5 · **LIT/FP composite**: 1 · **FP/STAT composite**: 1 · **FP/OBS composite**: 1. Total catalogued thresholds: 41 (with #22 classified as an observed value rather than a threshold; #41 classified as provisional). Three new entries (#39–#41) document Alberta-calibrated EG threshold alternatives; see §B.2.1.A–C and report_academic.md §5.2.8.
