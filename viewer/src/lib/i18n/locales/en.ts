...
export default {
	...
	body: {
		...
		clean: {
			...
			t5_r2_c: 'tail position on three of four partisan-fairness metrics — <code>seats@50/50</code> 51.7% (p99.99, roughly 69 of 1,010,000 reach it); mean-median p99.97; declination p98.8 (UCP-tail); efficiency gap +4.0% (p94.5, <em>near but below</em> the pre-registered 95th-percentile threshold); dependence-robust joint bound p&nbsp;≤&nbsp;1.76×10<sup>−6</sup> (≈ 1 in 568,000)',
