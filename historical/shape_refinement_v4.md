...
backward_dependencies:
  - analysis/methodology/commission_reference_shapes.md (documents the v3 mismatches this pass addresses)
  - analysis/methodology/shape_refinement_v3.md (the superseded Tier B approximation)
...
`analysis/methodology/commission_reference_shapes.md` as "unquantifiable
...
| `analysis/shape_refinement_v4_log.json` | Per-ED anchors + error bands (machine-readable) |
| `data/v0_1_refined_v4_minority_2026_eds.gpkg` | v4 minority polygons (three EDs updated, rest unchanged from v3) |
| `data/boundary_refinement_impact_v4.csv` | Per-ED v3-to-v4 VA-impact table |
