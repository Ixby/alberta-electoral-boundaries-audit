...
export default {
	...
	body: {
		...
		clean: {
			...
			defense3: '<strong>The "Population Equality" Defense:</strong> <em>("They had to draw weird boundaries to make sure every district had the exact same population.")</em> The minority map is actually much <em>worse</em> at population equality. Its Population Mean Absolute Deviation (MAD) was 4,707 — 48% wider than the majority map\'s 3,180. Measured against the neutral ensemble, the minority\'s population spread sits at the 99th percentile — only 1 in 100 neutral maps produces a worse spread. It sacrificed population equality to achieve its shape.',
