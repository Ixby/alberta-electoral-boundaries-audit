...
export default {
	...
	editorial_intro: {
		...
		p3: "Dit es dee Standardprozes. Disses Mol haft dee Standardprozes oppet Onjewehnliches voadjebrocht. Dee Kommissjon siene fief Jliede haft sech 3–2 jespalt derjch waut dee Koat utsiehe soll, un anstott sech aun een Empfehlung to stale haft see twee voadjebrocht: en <em>Mehrheits-Vüaschlag</em> (von dree Kommissjoonsmitjliede unjastütt) un en <em>Minoritäts-Vüaschlag</em> (von twee unjastütt). Beide lajte aum Doffl — un dee Laanddach haft beide Sied jelacht. En sepaurotes Komitee von MLAs, veasitte von Brandon Lunty — aunjestallt vom Premier fea dise spezifische Entscheiding — äwaseet nu en vea-Persone Onaufjenkliches Beirootjremjum, konstituiert unjda Rajjerungsmotsjoon 37 (jeschot April 21, 2026), dee dee Aufgoaw haft, en nieen 91-Sitz-Koat voadtostale. Dee Laanddach mott aules jenehme, waut daut Komitee lifret, veurrh November 2026.",
	...
	body: {
		...
		clean: {
			...
			prereg_body: "Vorrijistriaarunk bedüt, dee jienaujten Proowe, Schwälle, un voarjesajten Richtunge optoschriwe, bevoa man irgendwäl Dote bekikt, un dee Verpflichtunge in en öffentliches zeitgestempeltes Datensatz to sparre. Daut Open Science Framework (OSF) es daut öffentliche Datensatz, wua dee Pruewunk ähre Verpflichtunge archiviirt woare. Daut verhindert Nohpasse: wann en Resultoat nich sauwa herauskommt, kjann dee Schwäll noh dee Fact nich verandert un dann präsentiirt woare, aus wann daut imma dee Proow jewast wea. Aule fief strukturelle Proowe un vea partisan-Jerechtichjkjeit-Metrijen in dise Pruewunk woare bei OSF vorrijistriirt, bevoa anje Simulatsjoon jeläpt wea.",
		...
		litmus: {
			...
			table_r8_b: '6 jekoppelde Kettesijchnal',
			table_r8_c: '2 (voarrijistrijde BESTEE)',
