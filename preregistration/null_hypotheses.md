...
- **B5 MCMC percentile**: **PASSING** if minority's percentile is within the ensemble 5–95 band on ≥ 3 of 4 metrics. Current (canonical 2026-07-12 rerun): mean-median p99.97, declination p98.79, EG p94.54, seats-at-50/50 p99.99. None are at the 5/95 band edge; all four are in the extreme tails. **Amendment note:** Prior values (p2.5 declination, p89.72 seats@50/50, etc.) were from an earlier ensemble run and have been superseded. This represents a substantial shift in the minority's percentile position across all metrics.
