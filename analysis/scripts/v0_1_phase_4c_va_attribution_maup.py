...
attribution used in `v0_1_phase_4c_va_attribution.py` /
...
Inputs (read-only):
  ...
  data/v0_1_majority_2026_populations.csv   (for canonical ED name order)
  data/v0_1_minority_2026_populations.csv

Outputs:
  data/v0_1_phase4c_majority_2023_votes_maup.csv
  data/v0_1_phase4c_minority_2023_votes_maup.csv
  analysis/reports/phase_4c_va_to_2026_assignments_maup.csv
  analysis/reports/v0_1_phase4c_maup_summary.json

Forward: analysis/reports/v0_1_maup_area_weighted_analysis.md
Backward:
  analysis/scripts/v0_1_phase_4c_va_attribution.py    (centroid pipeline)
...
OUT_MAJ = DATA / "v0_1_phase4c_majority_2023_votes_maup.csv"
OUT_MIN = DATA / "v0_1_phase4c_minority_2023_votes_maup.csv"
OUT_PER_VA = ANALYSIS / "reports" / "phase_4c_va_to_2026_assignments_maup.csv"
