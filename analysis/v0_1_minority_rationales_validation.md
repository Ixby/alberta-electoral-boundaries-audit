...
- **CLOSED-FAIL** — already refuted by `v0_1_justification_tests_findings.md` (population/area math).
...
- **Test.** `analysis/submission_search_findings.md` + `analysis/v0_1_claim_significance_analysis.md` already assess public backing. Summary: three of seven contested minority configurations (RMH-Banff, ODH, Chestermere) materially have public support; one (Red Deer hybrids) is split; three (Airdrie 4-way, Nolan Hill-Cochrane, St. Albert minority alt) do not.
