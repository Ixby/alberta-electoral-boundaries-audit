...
The sunset clause stated in §4.1.4 applies to all metrics derived from any DPG pipeline stage: upon publication of official Elections Alberta shapefiles, the full six-stage pipeline is superseded and all DPG-dependent analyses are subject to mandatory recomputation.
