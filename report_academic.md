...
The audit's central directional claim (Lane 2 structural-irregularity scorecard fires 5/5 against the minority and 0/5 against the majority; corrected ReCom Lane-1 percentile of p98.6) survives all three rejections. H3's double-rejection (falsification test + v0_9 direct measurement) tightens the audit's mechanistic interpretation rather than weakening it: the load-bearing mechanism is **not** mean Polsby-Popper compactness; it is *what the minority's corridors connect*. The two substrate-stable measurements that survive every revision and every sampler — **municipal anchoring** (minority 14.5%, majority 71%) and **urban hybridization** (minority 25 hybrid EDs, majority 9, 12 of the minority's *new*) — are the load-bearing structural features. The remaining open question is which sub-feature of hybridization (city-cracking patterns specifically, urban-rural composition splits, or cut-edge density across municipal lines) carries the most signal; the audit does not claim to have decomposed it further.
