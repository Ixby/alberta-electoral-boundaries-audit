...
| Fisher combined p = 6.87×10⁻⁸ (Ch1 + Ch2) | **RETIRED 2026-06-10** (see note below) | Either Ch1 (Mahalanobis) or Ch2 (SZAT) p-value is corrected above α = 0.05 upon methodological review | §5.5; `findings/joint_outlier_score_summary.md` |
