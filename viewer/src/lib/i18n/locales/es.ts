...
export default {
	...
	stakes: {
		q1: {
			...
			body:
				'"Gerrymander" no es un término que usen los tribunales canadienses, y esta auditoría no lo aplica como veredicto. Lo que la auditoría sí puede decir es más acotado y factual: cuatro de las cinco pruebas estructurales que ejecuta señalan la <em>propuesta minoritaria</em> y ninguna señala la alternativa (la <em>propuesta mayoritaria</em>); la quinta prueba es neutral para ambas. Si ese patrón equivale a lo que la gente entiende informalmente por un "gerrymander" es un juicio que esta auditoría deja al lector.',
			footnote:
				'Los nombres "mayoritaria" y "minoritaria" provienen de una división 3–2 dentro de la Comisión de Límites Electorales (presidida por el juez Miller), que produjo dos propuestas rivales en lugar de una sola recomendación. La Legislatura ha dejado desde entonces ambas de lado y remitió la redistritación a un comité de cinco MLA (miembros de la Asamblea Legislativa) presidido por Brandon Lunty (un MLA del UCP); el comité supervisa un Panel Asesor Independiente de cuatro personas — dos nominadas por el premier (el Hon. Monte Solberg y Darwin Durnie) y dos por el líder de la oposición (el Dr. Gerard Kennedy y Brent Robinson) — encargado de producir una nueva propuesta de límites de 91 escaños antes de la fecha límite de noviembre de 2026.'
		},
		q2: {
		...
		q3: {
			...
			body:
				'Con un voto provincial de 50/50, las mediciones de la auditoría sitúan la propuesta minoritaria en un extremo estructural: menos de 100 de los 1.01 millones de mapas neutrales de comparación producen el mismo tipo de desequilibrio de escaños. Ese desequilibrio importa porque una mayoría de 60 de 89 escaños deja solo una oposición simbólica y es en la práctica inmune a la disidencia interna — no porque cruce algún umbral especial (la Asamblea de Alberta no tiene una regla de dos tercios; los mismos poderes procedimentales están al alcance de una mayoría mínima). Si la inclinación de la propuesta minoritaria es lo bastante grande como para empujar a un partido más allá de ese umbral de 60 escaños con porcentajes de voto <em>distintos</em> de 50/50 es una pregunta que esta auditoría aún no ha puesto a prueba. Si ese desequilibrio es aceptable es una pregunta para los albertanos, no para esta auditoría.'
		},
	...
	boundary: {
		...
		can_2:
			'Por separado, cuando se incorporan los datos electorales, el mapa minoritario se sitúa en el percentil 99.99 de 1.01 millones de mapas de comparación trazados algorítmicamente emparejados por equilibrio poblacional y contigüidad (el conjunto impone esos dos requisitos, no todos los criterios estatutarios, como las comunidades de interés). Menos de 100 de esos 1.01 millones de mapas neutrales alcanzan el mismo desequilibrio de escaños. La señal estadística combinada es de aproximadamente 1 en 350.000 bajo un proceso de trazado neutral. Dos instrumentos independientes — geométrico y estadístico — llegan a la misma conclusión.',
		can_3:
	...
	body: {
		...
		clean: {
			...
			intro_p2: 'Para responderla, la auditoría generó 1,010,000 mapas de Alberta simulados por computadora y matemáticamente neutrales. La simulación usó los shapefiles oficiales de Elections Alberta sobre la geografía de la comisión, sometiendo cada plan a los mismos requisitos de equilibrio poblacional (±25%) y contigüidad — los dos criterios que impone el algoritmo, no todos los factores estatutarios (no impone, por ejemplo, las comunidades de interés), de modo que el conjunto de comparación se entiende mejor como neutral en población y contigüidad y no como plenamente conforme con el estatuto. Los dos mapas de la comisión de 2026 se colocaron luego en esa distribución para ver qué tan normales son. La simulación corrió cuatro cadenas independientes de 252,500 pasos cada una, con la semilla base extraída de la baliza drand de Cloudflare y preregistrada en OSF antes de la ejecución.',
			...
			prereg_body: 'Preregistrar significa dejar por escrito las pruebas exactas, los umbrales y las direcciones predichas antes de mirar cualquier dato, y fijar esos compromisos en un registro público con sello de tiempo. El Open Science Framework (OSF) es el repositorio público donde están archivados los compromisos de esta auditoría. Esto impide el ajuste retroactivo: si un resultado no emerge limpiamente, el umbral no puede cambiarse después y presentarse como si siempre hubiera sido la prueba. Las semillas aleatorias de la auditoría se comprometieron a un faro público con sello de tiempo (drand de Cloudflare) antes de que se publicaran los shapefiles oficiales de Elections Alberta, de modo que las simulaciones no podían reejecutarse hacia un resultado elegido. La prueba de drenaje de vecinos se preregistró por completo en OSF — su umbral y dirección predicha fijados antes de la medición. Las pruebas restantes se reportan como exploratorias: sus semillas se precomprometieron, pero los nombres específicos de las pruebas y el método para combinarlas no se registraron en OSF antes de ejecutarlas, y el informe etiqueta cada hallazgo en consecuencia.',
			...
			t1_r4_b: '<strong>51.72% (66 de 1,010,000 planes superan el 51.69% de la minoría)</strong>',
			...
			super_label: 'POR QUÉ IMPORTA UNA GRAN MAYORÍA',
			super_body: 'Bajo el sistema de Westminster de Canadá, la Asamblea de Alberta no tiene ningún umbral de dos tercios que desbloquee poderes especiales: una mayoría gobernante — incluso una mínima — ya puede aprobar leyes y presupuestos, invocar la "clausura" para terminar el debate, cambiar las reglas de la Cámara y fijar la composición de cada comité. Lo que cambia una mayoría muy grande es el margen y la durabilidad, no el menú de poderes. Un gobierno que tiene 60 de 89 escaños es en la práctica inmune a la disidencia interna — un puñado de cruces de bancada no puede amenazarlo — y enfrenta a una oposición demasiado pequeña para forzar votaciones nominales o sostener el escrutinio en comité. La preocupación aquí es la concentración de escaños y el adelgazamiento de la oposición efectiva, no el cruce de un umbral procedimental.',
			...
			t4_r1_b: '51.72% de escaños UCP @ 50/50 (66 de 1,010,000 planes superan el 51.69% de la minoría)',
			...
			defense1: '<strong>La defensa de la "geografía política natural":</strong> <em>("Los votantes urbanos están naturalmente empaquetados; el mapa solo refleja la geografía de Alberta.")</em> Las 1,010,000 simulaciones ya toman en cuenta la geografía natural de Alberta. La geografía sí le da al UCP una ventaja de eficiencia de base — pero los dos mapas reales de comparación muestran dónde esa ventaja alcanza naturalmente su techo: tanto el mapa promulgado en 2019 como el mapa mayoritario de 2026 se sitúan en el percentil 78 en la métrica del punto de inflexión, y la posición más alta del mapa de 2019 en cualquier medida partidista está en los noventa bajos (declinación, percentil 91). El mapa minoritario se sitúa en el percentil 99.99 — un valor atípico extremo <em>incluso comparado con la línea de base naturalmente sesgada de Alberta</em>.',
			...
			defense3: '<strong>La defensa de la "igualdad poblacional":</strong> <em>("Tuvieron que trazar límites raros para asegurar que cada distrito tuviera exactamente la misma población.")</em> El mapa minoritario es en realidad mucho <em>peor</em> en igualdad poblacional. Su desviación media absoluta (MAD) de población fue 4,707 — 48% más amplia que la del mapa mayoritario (3,180). Medida sobre el sustrato del conjunto con shapefiles oficiales, donde el par de MAD comparable es 3,938 (minoría) frente a 2,827 (mayoría), la dispersión poblacional de la minoría se sitúa en el percentil 99 — solo 1 de cada 100 mapas neutrales produce una dispersión peor. Sacrificó la igualdad poblacional para lograr su forma.',
			...
			t5_r1_c: 'dentro del rango normal en cada métrica (<code>seats@50/50</code> 46.1% — p78; brecha de eficiencia +0.1%)',
		...
		impact: {
			...
			fig_alt: 'Gráfico de barras que compara cuatro pruebas de equidad estructural preregistradas lado a lado, más un panel de puntuación resumen. Las barras del mapa mayoritario se sitúan en cero o bien dentro de los rangos seguros. Tres de los cinco paneles tienen una línea de reprobación preregistrada (discontinua, roja): el exceso de población en el NE/centro de Calgary, los límites señalados por el presidente, y el panel resumen. En esos tres, la barra del mapa minoritario cruza la línea y la del mapa mayoritario permanece dentro. Los paneles de dispersión poblacional y de Airdrie no tienen línea de reprobación; la dispersión poblacional muestra a la mayoría en 3,180 y a la minoría en 4,707 personas de distancia del tamaño ideal de distrito. La quinta prueba preregistrada, el anclaje municipal, fue neutral para ambos mapas — ambos dentro de la norma canadiense de 70–85 % — por lo que no se representa; el panel resumen otorga a la minoría una puntuación de 4 de 5, contando el anclaje como neutral.',
			fig_caption: 'Las cuatro pruebas de equidad estructural preregistradas, lado a lado, más un panel de puntuación resumen. Las barras verde azulado son el mapa mayoritario; las barras moradas son el minoritario. Aparece una línea discontinua donde una prueba tiene un umbral de reprobación preregistrado: el exceso de población en el NE/centro de Calgary, los límites señalados por el presidente, y el panel resumen. La barra del mapa minoritario cruza cada línea mostrada; la del mapa mayoritario nunca. Los paneles de dispersión poblacional y de Airdrie no tienen línea de reprobación — la dispersión poblacional muestra a la mayoría en 3,180 y a la minoría en 4,707 personas de distancia del tamaño ideal de distrito. La quinta prueba preregistrada, el anclaje municipal, fue neutral para ambos mapas — ambos dentro de la norma canadiense de 70–85 % — por lo que no se representa aquí; el panel resumen otorga a la minoría una puntuación de 4 de 5, contando el anclaje como neutral.',
			...
			table_r3_a: 'Exceso de población del NE/centro de Calgary sobre el promedio',
			table_r3_b: '2.8%',
			table_r3_c: '11.5%',
		...
		litmus: {
			...
			fig_alt: 'Histograma que muestra la distribución de brechas de eficiencia entre 1,010,000 mapas neutrales de Alberta. La mayoría de los mapas se agrupan cerca de cero. El mapa de la comisión minoritaria (línea morada) se sitúa en el percentil 94 (+4.0%), en la cola derecha sombreada. El mapa mayoritario (línea verde azulado) se sitúa en +0.1%, bien dentro del rango normal.',
			fig_caption: 'Distribución de las <button class="vocab-term" data-def="una medida de qué tan desproporcionadamente se convierten los votos en escaños — los valores positivos favorecen al UCP, los negativos favorecen al NDP" aria-expanded="false">brechas de eficiencia</button> entre 1,010,000 mapas neutrales de Alberta trazados sobre la misma geografía. La mayoría de los mapas neutrales se agrupan cerca de cero; la cola derecha sombreada marca el 10% superior. El +4.0% de la propuesta minoritaria se sitúa en el <button class="vocab-term" data-def="el porcentaje de mapas que puntuaron más bajo — p94 significa que 94 de cada 100 mapas neutrales fueron menos partidistas que este" aria-expanded="false">percentil</button> 94 — una región que menos de 6 de cada 100 mapas neutrales alcanzan jamás. El +0.1% de la propuesta mayoritaria es indistinguible de lo que un proceso neutral típicamente produce.',
			...
			table_r2_a: 'Exceso de población del NE/centro de Calgary sobre el promedio',
			table_r2_b: '2.8%',
			table_r2_c: '11.5%',
		...
		november: {
			...
			quebec_p1:
				'Quebec ofrece la comparación más relevante para la situación de Alberta. La Commission de la représentation électorale (CRE) de Quebec es un órgano permanente e independiente de límites electorales, no una comisión ad hoc constituida por ciclo de redistribución. La CRE opera de forma continua y no puede ser disuelta ni eludida por acción del gabinete. Bajo la <em>Loi électorale</em> de Quebec, la CRE establece el mapa electoral final por sí misma: la Asamblea Nacional debate el informe de la comisión y escucha las representaciones, pero no vota para adoptarlo ni anularlo — dentro de los diez días posteriores a ese debate la comisión fija los límites, que se publican en la Gazette officielle. El efecto práctico es que un partido gobernante no puede, actuando solo con su propia mayoría, sustituir el mapa de la comisión por su mapa preferido; en la delimitación misma, el órgano independiente tiene la última palabra.',
			quebec_p2:
		...
		about_me: {
			...
			p3: 'Registros de compromiso de semillas y preregistro: <a href="https://osf.io/6pt83" rel="noopener">OSF:6pt83</a>, AsPredicted:#289,469, AsPredicted:#289,451 — las semillas aleatorias recibieron sello de tiempo en un faro público antes de que se publicaran los shapefiles oficiales; la prueba de drenaje de vecinos (#289,451) se registró antes de la medición, las demás se archivaron junto con el análisis exploratorio.',
			p4: 'Preguntas o correcciones: '
		},
		translation_about: {
	...
	chrome: {
		...
		map_intro: {
			...
			s4_tip:
				'En el §4, haga clic en <em>Mostrar los distritos señalados en el mapa</em> para resaltar la división de Airdrie y la zona del NE/centro de Calgary.',
			got_it: 'Entendido'
		},
		footer: {
