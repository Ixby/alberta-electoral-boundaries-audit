...
**Companion script:** `analysis/scripts/v0_9_municipal_anchoring_2019_baseline.py`
**Outputs:** `data/v0_1_2019_municipal_anchoring.csv` (per-ED, 87 rows); `data/v0_1_2019_municipal_anchoring_summary.json`.
