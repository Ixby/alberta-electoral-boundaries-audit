...
`analysis/v0_1_canonical_shapefile_log.md`.
...
| `analysis/v0_1_canonical_shapefile_log.md` | Full build log with per-district provenance |
| `analysis/v0_1_build_canonical_shapefiles.py` | Reproducible construction script |
