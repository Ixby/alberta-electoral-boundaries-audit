...
*Methodology and findings.* **Five non-partisan-bias signals all point in the same direction: the minority proposal diverges from the majority on every structural measure.** Population dispersion is 48 % wider (MAD: 4,707 versus 3,180); Calgary geographic-zone asymmetry is 12.2 % versus 0.4 %; Airdrie is split across four electoral divisions versus two; municipal-boundary anchoring covers 14.5 % of the minority perimeter versus 71.0 %; and three spatial anomalies were chair-flagged on the minority map, zero on the majority. On partisan-bias magnitude, the canonical shapefiles confirmed the minority map exhibits a compactness-weighted efficiency gap of -2.4% (structural advantage to the UCP), whereas the majority map sits at +1.5% (slight advantage to the NDP), further corroborating the joint outlier profile (Mahalanobis p = 1.60e-07).

*Conclusion.* All Efficiency Gap magnitudes remain below the 7 % threshold proposed in the academic literature by Stephanopoulos and McGhee (2014/2015) and never judicially adopted (see §5.2.8 for full threshold provenance). However, the minority's combination of failing five non-partisan structural thresholds alongside highly-irregular outlier status on the 250,000-map ReCom MCMC canonical ensemble generates a conclusive forensic divergence from the majority map. A sunset clause (§4.1.4) successfully triggered on May 6, 2026, transitioning all analysis from Derived Provisional Geometries (DPG) directly onto Elections Alberta canonical boundary lines.
...
| **2026 minority** | **population MAD** | **3,938** | **98.9** |
| 2026 majority | population MAD | 2,827 | 16.7 |
| 2026 minority | Reock proxy median | 0.578 | 100.0 (more compact) |
| 2026 majority | Reock proxy median | 0.568 | 100.0 (more compact) |
| 2026 minority | Reock pct<0.30 | 1.1 % | 0.1 (fewer non-compact EDs) |
| 2026 majority | Reock pct<0.30 | 2.3 % | 0.9 (fewer non-compact EDs) |

**Partisan metrics: all four extreme simultaneously on the minority map.** The canonical substrate resolves the DPG-era cross-method ambiguity: on official geometry the minority's EG is a p95.9 outlier, its mean-median is a p99.99 outlier, its declination sits at p0.4 (NDP-favoured tail), and its seats@50/50 of 0.5169 exceeds every plan in the 50k canonical ensemble. The majority map is within null on all four partisan metrics.
