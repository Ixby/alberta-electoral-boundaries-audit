...
- Reviewer #1 (methods / quantitative political science) — `v0_1_peer_review_methods.md`
- Reviewer #2 (legal / institutional) — `v0_1_peer_review_legal.md`
- Reviewer #3 (Canadian political-science lineage) — `v0_1_peer_review_canadian.md`
