...
export default {
	...
	body: {
		...
		clean: {
			...
			defense3: '<strong>La defensa de la "igualdad poblacional":</strong> <em>("Tuvieron que trazar límites raros para asegurar que cada distrito tuviera exactamente la misma población.")</em> El mapa minoritario es en realidad mucho <em>peor</em> en igualdad poblacional. Su desviación media absoluta (MAD) de población fue 4,707 — 48% más amplia que la del mapa mayoritario (3,180). Medida frente al conjunto neutral, la dispersión poblacional de la minoría se sitúa en el percentil 99 — solo 1 de cada 100 mapas neutrales produce una dispersión peor. Sacrificó la igualdad poblacional para lograr su forma.',
