...
- **Municipal anchoring (2e6c351, Issue #4) — RETRACTED on canonical geometry** — DPG-era result was 71.0 % maj / 14.5 % min to CSD edges (4.9× asymmetry); canonical result on official EA shapefiles is 80.0 % maj / 71.8 % min, both within the 70–85 % Canadian comparator norm. Retracted per §4.1.4 DPG sunset clause; see §5.8.5
