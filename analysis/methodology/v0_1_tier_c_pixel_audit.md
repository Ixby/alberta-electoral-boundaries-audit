...
backward_dependencies:
  - analysis/methodology/v0_1_shape_refinement_v4.md
  - analysis/v0_1_shape_refinement_v4_log.json
  - data/v0_1_refined_v4_minority_2026_eds.gpkg
  - data/v0_1_compactness_scores_refined.csv
...
The recommendation in `v0_1_shape_refinement_v4.md` to keep v4 as a parallel Tier C annex alongside v3 remains sound. Downstream analyses (Chen-Rodden, base-rate comparisons) should use v4 for first-order territorial framing and v3 for conservative "unquantifiable" framing, depending on the analysis goal.
