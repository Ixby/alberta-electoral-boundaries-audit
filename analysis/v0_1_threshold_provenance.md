...
backward_dependencies:
  ...
  - analysis/electoral_forensics_population.py (A1/A2/A3 thresholds)
  - analysis/v0_2_packing_cracking_analysis.py (B-series thresholds, 70/30 urban weight)
  - analysis/v0_3_monte_carlo_ci.py (Monte Carlo N, Uniform sampling ranges, 95 % CI)
  - analysis/check_voice_and_readability.py (Flesch-Kincaid targets)
  - analysis/v0_1_act_amendment_proposal.md (reform-proposal thresholds)
---
