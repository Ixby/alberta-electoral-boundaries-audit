...
data/v0_9_advance_vote_sensitivity.json with the seats_at_50_50 deltas
between A and B.

Forward: analysis/reports/v0_9_advance_vote_sensitivity.md
Backward:
...
OUT_JSON = DATA / "v0_9_advance_vote_sensitivity.json"
