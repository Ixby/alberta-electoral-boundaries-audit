...
The *Saskatchewan Reference* para. 33, delivered by McLachlin J., establishes "relative parity of voting power" must be weighed against permissible deviations for "geography, community history, community interests and minority representation." Critically, the Court did not prescribe a bright-line tolerance for population variance or other quantitative measures. Instead, it requires a holistic assessment in which deviations from strict equality are constitutionally defensible *if justified by the non-quantitative factors*. This standard has been applied in two leading post-Reference cases together bracketing the federal courts' discretion-review space. *Raîche v. Canada (Attorney General)*, 2004 FC 679, examined whether the federal Electoral Boundaries Commission for New Brunswick had drawn boundaries consistent with the effective-representation standard. Heneghan J. found a s.3 violation: the Commission's redrawing had insufficiently preserved the Acadian community of interest, and the court ordered the affected boundaries revisited. The case stands for the proposition community-of-interest considerations can require accepting greater population variance than strict equality would permit — and conversely, the proposition boundaries failing to give community of interest sufficient weight can be struck down even when their population variance is within statutory tolerances. *Cassista v. Canada (Attorney General)*, 2014 FC 398, applied the same framework to a different federal redistricting cycle and upheld the Commission's discretion, finding the contested boundaries within the range a reasonable commission could draw under the statutory mandate. Read together, the two cases bracket the discretion space: Raîche shows what insufficient community-of-interest protection looks like (boundaries struck down); Cassista shows what permissible exercise of discretion looks like (boundaries sustained). In neither case did the court examine partisan asymmetry; the constitutional inquiry centred on whether the non-quantitative factors had been weighed. This doctrinal architecture means partisan asymmetry, standing alone, does not trigger a constitutional violation under the Saskatchewan Reference standard — the asymmetry must be paired with either (a) unexplained deviations from population parity unjustified by geography, community of interest, or other permissible factors, or (b) evidence the non-partisan factors (geography, etc.) have been distorted *in service of* partisan outcomes rather than in service of legitimate statutory purposes.
...
The ratio between the 2021-population-sum-inside-a-2026-DPG-polygon and the commission's 2024 estimate of the same territory is **not** a clean scalar. Alberta's 14.69 % provincial growth between 2021 and 2024 was distributed unevenly — Calgary-ring cities such as Airdrie and Chestermere grew 20–30 %, rural territories grew 0–5 % — so applying a flat provincial growth factor to a regionally heterogeneous population surface introduces a structural bias into Phase 4F's per-ED validation deltas. The 81 of 86 majority and 87 of 89 minority hardstop failures originally documented in `data/INTEGRITY_STATUS.md` (computed against v0_5 DPG geometry; now bannered SUPERSEDED in `findings/phase4f_summary.json`) were a composite signal: real DPG transcription error plus cycle-lag growth heterogeneity, not separable from public data alone. **Canonical recompute (2026-06-11, `findings/phase4f_hardstop_canonical.md`):** on the official Elections Alberta shapefiles with area-weighted Statistics Canada 2021 DA aggregation, **89 of 89 majority EDs and 89 of 89 minority EDs fail the 2 % hardstop** (median |Δ| = 9.6 % majority / 10.4 % minority; max 47.0 % / 41.9 %). The v0_5 counts were lower only because the DPG substrate had 27 majority and 22 minority EDs with zero scoreable population (the polygons did not exist in v0_5); those EDs passed by being missing rather than by being within threshold. On clean canonical geometry the 2 % hardstop is too tight for the 2021-to-2026 cycle-lag delta on essentially every Alberta ED, which is the substrate-honest reading. Full treatment at `findings/cycle_lag_analysis.md` ([§1](#sec-1)) and the canonical re-run at `findings/phase4f_hardstop_canonical.md`.
...
**The provision is permissive, not mandatory.** §15(2) EBCA uses the formulation "The Commission *may have* an electoral division… *if the Commission is of the opinion* the electoral division should be established and at least 3 of the following criteria apply." Both the grant of permission ("may have") and the opinion gate ("if the Commission is of the opinion") are discretionary. A district satisfying 3 of 5 statutory criteria is eligible for §15(2) protection. The commission is not required to grant it.
...
The standard has been applied by federal courts in two principal cases. *Raîche v. Canada (Attorney General)*, 2004 FC 679, examined the federal Electoral Boundaries Commission for New Brunswick's redrawing of Acadian boundaries and found a s.3 violation: the Commission had insufficiently preserved the Acadian community of interest, and Heneghan J. ordered the affected boundaries revisited. *Cassista v. Canada (Attorney General)*, 2014 FC 398, applied the same framework to a later federal cycle and upheld the Commission's discretion, finding the contested boundaries within the range a reasonable commission could draw. Read together, the two cases bracket the discretion space: Raîche shows boundaries can be struck down when community of interest is given insufficient weight; Cassista shows boundaries fall inside discretion when permissible statutory factors are weighed. In neither case did the court focus on partisan asymmetry; the constitutional inquiry centred on whether the non-quantitative factors — geography, community of interest — were genuinely engaged. This case law establishes a crucial point: partisan asymmetry, standing alone, does not trigger a Saskatchewan Reference violation. Rather, asymmetry is constitutionally material only when paired with either (a) unjustified deviations from population parity unattributable to geography, community boundaries, or other statutory constraints, or (b) evidence permissible factors (geography, community of interest) have been distorted *in service of* partisan outcomes rather than applied in service of the statute's non-partisan purposes.
