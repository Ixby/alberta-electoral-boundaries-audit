...
backward_dependencies:
  ...
  - data/alberta_2019_populations.csv (2017 EBC Final Report values for reference)
  - analysis/reports/plan_b_cross_check.md (data-basis statutory discussion)
...
2021 decennial census of population. `analysis/reports/plan_b_cross_check.md`
...
`data/a1_legal_baseline_2019eds_2021census.csv`.
...
|-------------|-------|------|--------|
| 2019 map on 2017-report basis (commission-quoted) | 46,803 | 2,886 | `data/alberta_2019_populations.csv` (EBC 2017 Final Report pp. 60–61) |
...
- Output: `data/a1_legal_baseline_2019eds_2021census.csv` (per-ED
