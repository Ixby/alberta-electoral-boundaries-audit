...
* **Status (canonical, 2026-05-12; updated 2026-07-12):** Lane 1 is NOT demoted on the 1M canonical ensemble. The canonical run places the minority at MM p99.98, s50 p99.99, and Mahalanobis joint p = 8.80×10⁻⁷. The uniform-swing sensitivity is reported as a limitation (academic report §5.5), but Lane 1 contributes independently alongside Lane 2. Regional-swing recomputation against the canonical 1M ensemble is a blocker (see task list). Pre-canonical conclusion preserved for record. Note: numbers reflect the 2026-07-12 clean rerun after fixing ensemble chain defects. 

### 3.2 The "One-Metric Gerrymander" & Microtargeting (Efficiency Gap Immunity)

> **Canonical update (2026-05-12; updated 2026-07-12):** Pre-canonical values below are stale. Canonical 1M (post-2026-07-12 clean rerun): EG p94.4 (unflagged), MM p99.98 (flagged), Decl p98.79 UCP-tail (flagged), s50 p99.99 (flagged). Three metrics individually flag; EG does not. Mahalanobis D = 5.80, p = 8.80×10⁻⁷. "One-metric" framing no longer applies. Pre-canonical text preserved for record. **[Amendment 10, 2026-06-12 — declination sign corrected.** The "p1.21 / NDP-tail / disagrees-with-EG" reading here used the swapped-operand convention (δ_audit = −δ_Warrington), a code-side artefact at `mcmc_ensemble.py:215`, now retired. Under the corrected Warrington convention the minority's declination is +0.077, **p98.79, UCP-tail** — it AGREES with EG, mean-median, and seats@50/50 (four of four in the UCP-favoured direction). The text here is preserved as the pre-correction record. See `reports/academic/report_academic.md` §5.4.9 and Amendment 10 in `findings/pre_registration_amendment_log.md`.**]**
...
The 1,010,000-plan canonical ensemble (post-2026-07-12 clean rerun) reinstates all four partisan-fairness flags. Against official Elections Alberta shapefiles: EG p94.4 (below the 95th-percentile individual threshold, but contributes to joint test), MM p99.98 (flagged), Declination p98.79 UCP-tail (flagged), seats@50/50 p99.99 (flagged). The Mahalanobis joint test (D = 5.80, p = 8.80×10⁻⁷) captures the joint extremity; the Fisher combination with Ch2 SZAT (p = 0.0024) yields p = 4.61×10⁻⁸. **[SUPERSEDED 2026-06-10:** the Fisher combination is retired (channel dependence, Brown 1975; SZAT fails a block-permutation null at p ≈ 0.19). Operative joint headline: Ch1 alone p = 8.80×10⁻⁷ / Bonferroni p ≤ 1.76×10⁻⁶. See `reports/academic/report_academic.md` §4.3.3, §5.5.**]** **[Amendment 10, 2026-06-12 — declination sign corrected.** The "p1.21 / NDP-tail / disagrees-with-EG" reading here used the swapped-operand convention (δ_audit = −δ_Warrington), a code-side artefact at `mcmc_ensemble.py:215`, now retired. Under the corrected Warrington convention the minority's declination is +0.077, **p98.79, UCP-tail** — it AGREES with EG, mean-median, and seats@50/50 (four of four in the UCP-favoured direction). The text here is preserved as the pre-correction record. See `reports/academic/report_academic.md` §5.4.9 and Amendment 10 in `findings/pre_registration_amendment_log.md`.**]**
...
The Parts 1–3 statistical confounds affect Lane 1 magnitude claims at the margins; they do not reach Lane 1's joint p-value (operative: Ch1 p = 8.80×10⁻⁷ / Bonferroni p ≤ 1.76×10⁻⁶; the earlier Fisher p = 4.61×10⁻⁸ was retired 2026-06-10) and they do not reach any Lane 2 finding. Four Lane 2 structural findings survive canonical recomputation: population MAD 48% wider, Airdrie 4-way split, 3 chair-flagged anomalies, and NE/central Calgary population asymmetry. All four pre-registered tests fire for the minority; none fire for the majority. This structural pattern is not affected by any confound in Parts 1–3.
