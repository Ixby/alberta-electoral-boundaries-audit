...
been computed (analysis/scripts/v0_9_polsby_popper.py); this script fires
...
Dependencies
  ...
  Backward : data/v0_9_reock_per_district.csv
             analysis/reports/v0_9_reock_verdict.md
"""
...
OUT_CSV = ROOT / "data" / "v0_9_reock_per_district.csv"
