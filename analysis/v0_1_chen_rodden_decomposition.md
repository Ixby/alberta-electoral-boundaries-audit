...
Script: `analysis/v0_1_chen_rodden_decomposition.py`.
...
> `analysis/v0_1_chen_rodden_decomposition.md`; machine-readable outputs
> in `data/v0_1_chen_rodden_decomposition.{csv,json}`.

## 7. Files produced

- `analysis/v0_1_chen_rodden_decomposition.py` — reproducible script.
- `analysis/v0_1_chen_rodden_decomposition.md` — this writeup.
...
- DeFord, D., Duchin, M. & Solomon, J. (2021). "Recombination: A family
  ...
  3(1).
- `analysis/v0_1_chen_rodden_alberta_validation.md` — prior Chen-Rodden
  validation for Alberta (direction transfers, mechanism differs; Moran's
  I = 0.7534, p < 0.001).
- `analysis/v0_1_mcmc_100k_and_full_coverage.md` — MCMC ensemble method
  and convergence diagnostics.
- `analysis/v0_1_sign_convention_resolution.md` — paper-vs-script sign
