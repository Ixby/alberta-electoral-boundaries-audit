...
## Inputs available (produced by `analysis/scripts/phase_4c_prep.py`)
...
Re-execute `analysis/scripts/v0_2_packing_cracking_analysis.py` with the
...
Output: `analysis/reports/phase_4c_gerrymander_comparison.md` with v0.2 vs 4C
metric deltas and significance.

## Stage 7 - Monte Carlo CIs

Re-run `analysis/scripts/v0_3_monte_carlo_ci.py` on the VA-resolution data to get
