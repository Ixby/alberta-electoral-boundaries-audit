...
export default {
	...
	body: {
		...
		clean: {
			...
			t5_r1_b: 'clean — crosses <em>no</em> structural threshold; retains more of 2019\'s rural divisions than the minority (exploratory Casing 12 count)',
			...
			t5_r2_b: '<strong>crosses 4 of 5 structural thresholds</strong> by a wide margin (anchoring neutral — both maps within Canadian norm); also retains the fewest rural-anchored divisions of the three maps — the exploratory count run at its own accusation (Casing 12)',
		...
		impact: {
			...
			table_intro: "The same five tests in tabular form, with each test's threshold stated alongside the result. The summary row is the audit's <em>count</em> of tests failed out of the five. A final italic row reports the rural-division count run at the minority's own accusation (Casing 12) — exploratory, and never counted in the summary.",
			table_col_test: 'Test',
			...
			table_r7_a: '<em>Rural-anchored divisions retained, of 2019\'s 31 (exploratory, 2026-07-14 — run at the minority\'s own accusation; NOT one of the pre-registered five and NOT counted in the summary above)</em>',
			table_r7_b: '<em>28 (absorbs 3, adds 2 new)</em>',
			table_r7_c: '<em>23 (absorbs 7, adds none)</em>',
			table_r7_d: '<em>Count cuts against the accuser; the companion variance test supports them — see Casing 12</em>',
