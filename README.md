...
**1M canonical MCMC run in progress (ESS upgrade) — chain1 stalled.** The authoritative ensemble (§5.4.9) used 250,000 plans (4 chains × 62,500 steps), producing partisan-metric ESS of 379–452. A 1,000,000-step run launched 2026-05-11 to raise ESS to ~1,500–1,800. As of 2026-05-11 14:45: chain0 complete (252,500 rows), chain2 at 107,500 rows (~18% of extension), chain3 at 72,500 rows (~4% of extension); chain1 is stuck on chunk 12/50 — computing but not completing steps, consistent with a ReCom sampler hang in a low-connectivity partition state. If chain1 does not recover within 30–60 minutes, it will be killed and the run accepted as a 3-chain result (~750k total steps, ESS ~1,100–1,350).
