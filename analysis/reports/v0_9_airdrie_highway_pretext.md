...
(Source: `data/v0_9_airdrie_quadrant_anchoring.csv`. City-limit % attributed first when a segment matches both substrates, so highway % is the residual highway match.)
...
- Metrics CSV: `data/v0_9_airdrie_quadrant_anchoring.csv` (7 rows, 11 cols)
- Script: `analysis/scripts/v0_9_airdrie_quadrant_anchoring.py`
...
Backward:
  ...
  analysis/methodology/v0_1_terms_of_reference_verbatim.md
