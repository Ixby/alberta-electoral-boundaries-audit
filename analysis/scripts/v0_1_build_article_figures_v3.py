"""
v0_1_build_article_figures_v3.py
...
Run
  PYTHONIOENCODING=utf-8 python analysis/scripts/v0_1_build_article_figures_v3.py
...
Dependencies
  ...
  Backward : maps/article/figure_*_v3.png,
             analysis/reports/v0_1_article_figures_v3.md,
