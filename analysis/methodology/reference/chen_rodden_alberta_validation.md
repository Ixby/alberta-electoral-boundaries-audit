...
- `data/chen_rodden_simulation.csv` — per-plan ensemble metrics (150 plans, Test 3).
- `data/chen_rodden_summary.json` — structured summary (Tests 1, 2, 3).
