...
export default {
	...
	top_callouts: {
		...
		gerrymander_body: 'On the audit\u2019s joint partisan-bias score, the commission\u2019s minority map sits in the extreme tail of 1,010,000 algorithmically-drawn neutral comparison maps \u2014 approximately 66 of them reach its tipping-point seats@50/50 value, with a dependence-robust joint upper bound of roughly 1&nbsp;in&nbsp;568,000 under that reference distribution. The majority map falls well within normal range.',
		tldr_label: 'TL;DR',
	...
	body: {
		...
		clean: {
			...
			t1_r4_b: '<strong>51.72% (66 of 1,010,000 plans exceed the minority\'s 51.69%)</strong>',
			...
			t4_r1_b: '51.72% UCP seats @ 50/50 (66 of 1,010,000 plans exceed the minority\'s 51.69%)',
