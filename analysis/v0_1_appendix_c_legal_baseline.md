...
backward_dependencies:
  - analysis/v0_1_a1_legal_baseline_2021_census.py (this computation)
  ...
  - analysis/v0_1_plan_b_cross_check.md (data-basis statutory discussion)
...
2021 decennial census of population. `analysis/v0_1_plan_b_cross_check.md`
...
`analysis/v0_1_a1_legal_baseline_2021_census.py`; per-ED results in
...
`analysis/v0_1_track_l_drift.py` reports 5 of 87 2019 EDs outside ±25 %
...
- Script: `analysis/v0_1_a1_legal_baseline_2021_census.py`
...
- Reproducibility: `PYTHONIOENCODING=utf-8 python
  analysis/v0_1_a1_legal_baseline_2021_census.py` from the repository
