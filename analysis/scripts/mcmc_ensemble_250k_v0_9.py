...
Outputs
-------
- data/v0_1_mcmc_ensemble_samples_250k_v0_9.csv
- data/v0_1_mcmc_real_map_scores_250k_v0_9.json
- data/v0_1_mcmc_ensemble_percentiles_250k_v0_9.csv
- data/v0_1_mcmc_convergence_diagnostics_250k_v0_9.json
- data/maps/mcmc/ensemble_distribution_250k_v0_9_{metric}.png
- data/maps/mcmc/running_mean_250k_v0_9_{metric}.png

Usage
-----
    python analysis/scripts/mcmc_ensemble_250k_v0_9.py [--n-steps 250000]
...
SAMPLES_CSV = DATA / "v0_1_mcmc_ensemble_samples_250k_v0_9.csv"
SCORES_JSON = DATA / "v0_1_mcmc_real_map_scores_250k_v0_9.json"
PERCENTILES_CSV = DATA / "v0_1_mcmc_ensemble_percentiles_250k_v0_9.csv"
CONVERGENCE_JSON = DATA / "v0_1_mcmc_convergence_diagnostics_250k_v0_9.json"
...
def main(n_steps: int = 250000, seed: int = None, pop_deviation: float = 0.25,
    ...
    seed = seed if seed is not None else get_canonical_seed("mcmc_ensemble_250k_v0_9")
    np.random.seed(seed)
    import random as _random
    _random.seed(seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=int, default=42,
                        help="Base seed; per-chain seed = base*100k + chain*1k")
