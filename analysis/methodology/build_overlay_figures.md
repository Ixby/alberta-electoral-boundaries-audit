...
| Majority 89-ED list | `data/majority_2026_populations.csv` | Completeness check + target list |
| Majority rename crosswalk | `data/majority_hybrid_crosswalk.csv` | Lineage for Tier C proxies |
