...
`data/v0_9_reock_per_district.csv` (178 rows: 89 minority + 89 majority). Script: `analysis/scripts/v0_9_reock.py`. Implementation uses `shapely.minimum_bounding_circle` (GEOS, Shapely 2.0+) with a Welzl fallback for older Shapely; both reproduce.
