...
4. **"Counties" vs "communities of interest" in §14.** Not directly relevant to §15(2) but the plain-language paraphrase discrepancy is flagged in `v0_1_terms_of_reference_audit.md` §2.6.

---

## 8. Source citations

- Alberta *Electoral Boundaries Commission Act*, RSA 2000 c. E-3, King's Printer consolidation 2024-12-05: verbatim §15(2), §15(3) (see `analysis/methodology/v0_1_terms_of_reference_verbatim.md`).
