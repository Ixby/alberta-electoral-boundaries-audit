> **Backward:**
> - `analysis/scripts/v0_1_neighbour_drain_adjacency.py` — companion script producing the adjacency test
> - `analysis/scripts/packing_cracking_analysis.py` — §5.3 symmetric-blending pipeline for vote substrate
> - `data/v0_2_canonical_majority_2026_eds_topoclean.gpkg`, `data/v0_2_canonical_minority_2026_eds_topoclean.gpkg`
> - `data/alberta_2019_eds/EDS_ENACTED_BILL33_15DEC2017.shp`
>
> **Forward:**
> - `findings/drain_label_shuffle_null.md` — label-shuffle null test on this adjacency graph
> - `reports/academic/report_academic.md` — incorporates the drain finding
...
| Majority 2026 | 89 | 251 | 502 | 8 | 6 | 2 | 1.59% |
| Minority 2026 | 89 | 257 | 432 | 6 | 2 | 4 | 1.39% |

## Inter-map coupling ratios

- Minority / Majority (coupled): **0.33x**
- Minority / 2019 (coupled): **0.40x**
- Majority / 2019 (coupled): **1.20x**

## Threshold sensitivity

| (s, m) | 2019 coupled | Majority coupled | Minority coupled | Min/Maj |
|---|---|---|---|---|
| (0.10, 0.08) | 11 | 12 | 5 | 0.42x |
| (0.15, 0.05) | 5 | 6 | 2 | 0.33x |
| (0.20, 0.03) | 5 | 4 | 2 | 0.50x |
...
The minority/majority ratio of coupled signals is 0.33x — no material difference. The adjacency scale does not amplify the §5.3.1/§5.3.2 findings; the existing tests operate at the right scale.
