...
export default {
	...
	glossary: {
		...
		'lunty-committee': {
			...
			definition:
				"A five-MLA Select Special Committee on Electoral Boundaries chaired by Brandon Lunty — a Premier-appointed MLA — created under Government Motion 37 (April 21, 2026). The committee oversees a separate four-person Independent Advisory Panel that draws the actual map; the committee then reports to the Legislature before the November 2026 deadline. Both bodies are separate from the EBC and are not part of the standard EBCA process."
		},
		'advisory-panel': {
			term: 'Independent Advisory Panel',
			definition:
				"The four-person panel appointed by the Lunty committee under clause C(d)(ii) of Government Motion 37 to draw a 91-seat boundary recommendation. The Premier nominated the Hon. Monte Solberg and Darwin Durnie; the Leader of the Opposition nominated Dr. Gerard Kennedy and Brent Robinson. A fifth seat — a chair nominated by a sitting or retired judge — went unfilled after Alberta's acting chief justice declined to make a nomination."
		},
		ebca: {
			term: 'EBCA',
			definition:
	...
	body: {
		...
		november: {
			...
			intro: "Neither commission map is in force. In April 2026 the government set both aside and referred redistricting to a Select Special Committee of five MLAs — three UCP, two NDP — chaired by Brandon Lunty (UCP, Leduc-Beaumont) under Government Motion 37 (passed April 21, 2026). The committee itself does not draw the map. It oversees a separate Independent Advisory Panel tasked with producing a 91-seat boundary proposal. Motion 37 contemplated five panel members — a chair nominated by a sitting or retired judge, two members nominated by the Premier, and two by the Leader of the Opposition — but Alberta's acting chief justice declined to nominate a chair, and the panel now operates with the four appointees the committee confirmed: the Hon. Monte Solberg and Darwin Durnie (Premier's nominees) and Dr. Gerard Kennedy and Brent Robinson (Opposition nominees). The committee must deliver its report to the Legislature by November 2, 2026. Unlike the original commission, neither the committee nor the panel is required to hold public hearings; the panel draws on submissions the original commission gathered. When the committee's map is released, this audit will apply the same methodology to evaluate it.",
