...
backward_dependencies:
  - analysis/v0_1_commission_reference_shapes.md (PO 2026-04-23 corrections recorded here)
  - analysis/v0_1_shape_refinement_v4.md (the superseded Tier C approximation)
  - analysis/v0_1_shape_refinement_v4.py (pipeline v5 extends)
...
1. **Okotoks is NOT subtracted.** v4 applied `okotoks_m.buffer(50)` difference, which was a demonstrable error: the PO reference shows Okotoks sits inside De Winton at the ED's south-east-most edge. This matches the original reference observation ("encompasses the Town of Okotoks") in `v0_1_commission_reference_shapes.md`. v5 removes the subtraction step; Okotoks remains inside the polygon.
...
| Path | Purpose |
|---|---|
| `analysis/v0_1_shape_refinement_v5.py` | Reproducible pipeline |
...
```
PYTHONIOENCODING=utf-8 python analysis/v0_1_shape_refinement_v5.py
```
