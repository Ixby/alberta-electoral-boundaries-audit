...
**1M canonical MCMC run in progress (ESS upgrade).** The authoritative ensemble (§5.4.9) used 250,000 plans (4 chains × 62,500 steps), producing partisan-metric ESS of 379–452 — sufficient for reliable percentile estimation but below the publication-grade threshold (~1,000–2,000). A 1,000,000-step run against the same canonical Elections Alberta shapefiles and seed launched 2026-05-11; expected completion ~2026-05-12. Partisan-metric ESS will scale approximately 4× to ~1,500–1,800. Percentile placements from the 250k run are not expected to shift materially; the 1M results will be incorporated when available and will eliminate the ESS caveat on the Mahalanobis joint-tail test.
