...
- **Pre-registered checklist** at `analysis/reports/pre_registration_draft.md` plus two dated amendments documenting all methodology evolution. This documents what the author committed to *before* measuring; deviations are documented.
