...
export default {
	...
	boundary: {
		...
		can_2:
			"La proposition minoritaire échoue à 4 des 5 tests structurels pré-enregistrés ; le cinquième (l'ancrage) est neutre — les deux cartes restent dans la norme canadienne. La proposition majoritaire n'échoue à aucun des 4 tests déclenchés.",
		can_3:
