...
See `analysis/methodology/v0_1_sign_convention_resolution.md` for Phase 1 (sign-
...
|---|---|---|---|---|---|---|
| 1 | 2019 EG = -2.64% | `report_academic.md:235`, `report_public.md:107` | `analysis/scripts/v0_2_packing_cracking_analysis.py` `main()` | -2.6362% | within tol | OK |
...
| 36 | 2015 prov total = 1,433,745 | `analysis/reports/v0_1_2015_cross_election_analysis.md:73` | `data/v0_1_alberta_2015_results.csv` total_all | 1,433,745 | exact | OK |
| 37 | 2015 NDP 2P = 43.98% | `analysis/reports/v0_1_2015_cross_election_analysis.md:76` | 2015 CSV | 43.97% | within tol | OK |
| 38 | 2015 rural NDP 2P = 35.05% | `analysis/scripts/v0_3_monte_carlo_ci.py:13` | Track Z computed | not reverified | n/a | CHECK NEEDED |
| 39 | 2019 rural NDP 2P = 26.47% | `analysis/scripts/v0_3_monte_carlo_ci.py:13` | Track Z computed | 26.5% (v0_3 rerun) | within tol | OK |
| 40 | 2023 rural NDP 2P = 33.47% / 33.5% | `analysis/scripts/v0_3_monte_carlo_ci.py`, v0_2 rerun | v0_2 `main()` prints 33.5% | within tol | OK |
...
| 50 | Airdrie population = 74,100 (2021) | `analysis/reports/v0_1_justification_tests_findings.md:95`, `report_public.md:319` | StatsCan 2021 census | 74,100 | OK | OK |
...
- **Drift #32 (89.3% vs 90.5%).** The paper quotes 89.3% in six places.
  ...
  `analysis/methodology/v0_1_reproducibility_verification.md:54` already acknowledges
...
1. **Track Z file** (`analysis/reports/v0_1_2015_cross_election_analysis.md`):
...
| # | Cited path | Cited in | Actual location | Severity |
|---|---|---|---|---|
| F6 | `v0_1_rural_gap_ed_comparison.csv` (no dir prefix) | `analysis/reports/v0_1_rural_gap_findings.md:125` | `analysis/v0_1_rural_gap_ed_comparison.csv` | LOW — relative to the file it's cited in, this is OK |
...
- `analysis/methodology/v0_1_alberta_government_databases_survey.md` — cited in
  `report_academic.md:870`. File exists.
- `analysis/methodology/v0_1_commission_source_provenance.md` — cited in
  `report_academic.md:131,871`. File exists.
- `analysis/reports/v0_1_byelection_assessment.md` — cited in
  `report_academic.md:262,872`. File exists.
- `analysis/methodology/v0_1_appendix_c_legal_baseline.md` — cited in
  `report_academic.md:832,873`. File exists.
- `analysis/methodology/v0_1_threshold_provenance.md` — cited at `report_academic.md:874`.
  File exists.
- `analysis/methodology/v0_1_canadian_base_rate_computed.md` — cited at `report_academic.md:875`.
  File exists.
- `analysis/reports/v0_1_pre_registration_draft.md`,
  `analysis/reports/v0_1_pre_registration_platform_analysis.md` —
  cited at `report_academic.md:386,876`. Files exist.
- `analysis/methodology/v0_1_338canada_riding_level.md` — cited at
...
- **Premier Smith quote "did not want to lose two rural ridings":**
  ...
  independently verified in this session. `analysis/reports/v0_1_91_seat_preliminary.md:30`
...
- **Chair Miller Recommendation 5 quote (pp. 66-67):** Cited in
  `analysis/reports/v0_1_chair_recommendation_5_analysis.md:23-40`. The `.temp/commission_report.pdf`
...
2. **[CRITICAL — Track Z framing collision]** Amend
   `analysis/reports/v0_1_2015_cross_election_analysis.md`. The current file
...
4. **[MEDIUM — broken file refs]** Fix `source_maps/` prefix in 5 files:
   ...
   - `analysis/reports/v0_1_section_C_geographic_coherence.md:104`
   - `analysis/methodology/v0_1_data_preparation.md:129-131`
   - `analysis/methodology/v0_1_shape_refinement.md:18`
...
- `analysis/methodology/v0_1_sign_convention_resolution.md` — Phase 1 verdict.
- `analysis/reports/v0_1_consistency_audit.md` — this file (Phases 2-6).
