...
- **District-level minority population:** `data/v0_1_minority_2026_populations.csv` row 81 (Rocky Mountain House-Banff Park, population 38,298, deviation -30.28%, NOT within ±25% — the minority itself classifies this as a Rest-s15(2) district requiring the area exception).
...
- This file: `analysis/methodology/v0_1_banff_extension_population_check.md`.
...
- Cross-references: `analysis/reports/v0_1_justification_tests_findings.md` Test 2; `analysis/methodology/v0_1_minority_rationales_validation.md` §R12; `report_academic.md` §5.1.4, §5.3.3, §5.9.6 Claim 3.
