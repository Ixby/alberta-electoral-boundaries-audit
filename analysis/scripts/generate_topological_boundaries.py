...
Motivation
----------
Phase 4F validation (data/v0_1_validation_deltas.csv) fails the
...
-------
  ...
  analysis/reports/tier_c_sweep_log.csv
  data/tier_c_sweep_summary.json
  data/validation_deltas_v2.csv  (Phase 4F rerun)
  analysis/reports/tier_c_sweep_analysis.md

Forward: analysis/reports/tier_c_sweep_analysis.md
Backward:
...
SWEEP_LOG_CSV = REPORTS / "tier_c_sweep_log.csv"
SWEEP_SUMMARY_JSON = DATA / "tier_c_sweep_summary.json"
SWEEP_ANALYSIS_MD = REPORTS / "tier_c_sweep_analysis.md"
...
**Generated:** {gen_at}
**Script:** `analysis/scripts/v0_1_generate_topological_boundaries.py`
...
def main():
    ...
    pre = pd.read_csv(DATA / "v0_1_validation_deltas.csv")
