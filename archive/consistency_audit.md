...
`report_academic.md`, `analysis/`, and `historical/`. Phase numbering
follows the audit prompt.

See `analysis/methodology/sign_convention_resolution.md` for Phase 1 (sign-
...
- **Broken references (Phase 4):** 3 broken / miscited file paths
  ...
  internal-dir citation to `data/rural_gap_ed_comparison.csv` when
...
|---|---|---|---|---|---|---|
| 1 | 2019 EG = -2.64% | `report_academic.md:235`, `report_public.md:107` | `analysis/scripts/packing_cracking_analysis.py` `main()` | -2.6362% | within tol | OK |
...
| 18 | MAD majority = 3,180 | `report_academic.md:141`, `report_public.md:67` | `data/majority_2026_populations.csv` | 3179.62 | within tol | OK |
| 19 | MAD minority = 4,707 | `report_academic.md:141`, `report_public.md:67` | `data/minority_2026_populations.csv` | 4706.76 | within tol | OK |
...
| 42 | NDP excess = 9.3% | `chen_rodden_alberta_validation.md:74`, `report_public.md:137`, `report_academic.md:301` | chen_rodden script | not re-executed here | n/a | CHECK NEEDED |
...
| 46 | Moran's I = 0.7534, p < 0.001 | `chen_rodden_alberta_validation.md:56`, `report_academic.md:302` | chen_rodden script | not re-executed | n/a | CHECK NEEDED |
...
| 54 | Cochrane commuters 35.8% to Calgary / 49.2% local | `report_public.md:238`, `cochrane_journey_to_work.md` | StatsCan Table 98-10-0459 | not reverified | n/a | CHECK NEEDED |
...
- **Drift #32 (89.3% vs 90.5%).** The paper quotes 89.3% in six places.
  ...
  Hat-Brooks direct renames, see `packing_cracking_analysis.py:308`),
  ...
  `analysis/methodology/reproducibility_verification.md:54` already acknowledges
...
- **Drift #49 (Airdrie 84,000 vs 74,100).** Both figures appear in the
  ...
  `justification_tests_findings.md:95` and cited in
...
- **Drift #51 (Red Deer 106,000 vs 100,844).** 106,000 appears in
  `report_public.md:306,377` and `section_C_geographic_coherence.md:62`;
...
| D8 | UCP is the more-packed party by excess wasted votes (15.9% vs 9.3%) | `report_academic.md:301`, `report_public.md:137`, `chen_rodden_alberta_validation.md:74` | Chen-Rodden decomposition | This is ORTHOGONAL to EG sign — it's a wasted-vote-rate-by-party claim | Paper convention consistent | NO |
...
|---|---|---|---|---|
| F1 | `source_maps/minority_alberta_overview.jpg` | `report_academic.md:437`, `section_C_geographic_coherence.md:104`, `data_preparation.md:129` | `maps/minority_alberta_overview.jpg` | MEDIUM — three files have wrong directory prefix |
| F2 | `source_maps/minority_edmonton.jpg` | `report_academic.md:438`, `section_C_geographic_coherence.md:104`, `data_preparation.md:130` | `maps/minority_edmonton.jpg` | MEDIUM |
| F3 | `source_maps/minority_other_cities.jpg` | `report_academic.md:439`, `section_C_geographic_coherence.md:104`, `data_preparation.md:131` | `maps/minority_other_cities.jpg` | MEDIUM |
| F4 | `source_data/maps/hires/` | `shape_refinement.md:18` | `data/maps/hires/` | LOW |
...
None detected. All `historical/` files cited (`submission_search_log.md`,
...
- `.temp/commission_report.pdf` — cited in `chair_recommendation_5_analysis.md`.
...
- `analysis/methodology/alberta_government_databases_survey.md` — cited in
...
- `analysis/methodology/threshold_provenance.md` — cited at `report_academic.md:874`.
  File exists.
...
| C6 | Chen & Rodden (2013) | §3.6, §7, `chen_rodden_alberta_validation.md` | `L902` — *Quarterly Journal of Political Science* 8(3) 239-269 | OK |
...
- **338Canada April 12, 2026 snapshot (63 UCP / 24 NDP / UCP majority
  >99%):** Cited from `analysis/methodology/338canada_riding_level.md` which
  depends on `analysis/scripts/338canada_scraper.py`. The scraper's output
  is in `data/338canada_historical_snapshots.csv` and
  `data/338canada_per_riding_87seat.csv`. Not re-verified this
...
- **Chair's "did not condone" and "substantively unreasonable" phrases
  (`chair_recommendation_5_analysis.md:67`):** Quote appears in
...
8. **[LOW — rural baseline documentation]** The `monte_carlo_ci.py`
...
9. **[LOW — v0_3 print label convention]** Lines 158-159 of
   `monte_carlo_ci.py` currently print:
   ```
...
10. **[LOW — language about "Alberta's natural UCP-favourable floor"]**
    ...
    `report_academic.md:306`, `chen_rodden_alberta_validation.md:107,140`,
