...
| Mahalanobis D² significance | p < 0.05 (empirical, against ensemble distribution) | Standard (chi-squared approximation for high-dim feature spaces; Mahalanobis 1936) | D² computed against 1M-plan covariance matrix. Minority p = 8.80×10⁻⁷; majority p = 0.102. Both against the 4-dimensional (EG, MM, Declination, Seats@50/50) feature space. |
...
| Fisher combination significance | p < 0.05 | Fisher (1925) combining k=2 independent tests; T ∼ χ²(4) | T = 39.87, p = 4.61×10⁻⁸. Independence confirmed at ρ = −0.0014 (§G1). **— RETIRED 2026-06-10; see note below.** |
