...
> `analysis/methodology/canadian_base_rate_computed.md` and
...
> `analysis/methodology/canadian_base_rate_computed.md` and
> `data/canadian_redistribution_base_rate.csv`. The method uses
