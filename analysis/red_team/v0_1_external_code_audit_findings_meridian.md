...
- **Files:**
  - [v0_1_targeted_gerrymander_burst.py:51-52](analysis/scripts/v0_1_targeted_gerrymander_burst.py#L51-L52)
  - [v0_1_targeted_gerrymander_burst_ndp.py:52-53](analysis/scripts/v0_1_targeted_gerrymander_burst_ndp.py#L52-L53)
...
- **Description.** Both burst scripts contain a `score(partition)` helper that builds parallel UCP/NDP arrays by independently iterating two separate gerrychain Tally dicts:
  ...
  ```
  This is the **exact pattern** Gemini's CRITICAL #2 flagged in `run_ensemble`. The fix Gemini put in place there — explicit key alignment via `keys = list(partition.parts.keys())` then index by `[k]` — was applied to [v0_1_mcmc_ensemble.py:451-453](analysis/scripts/v0_1_mcmc_ensemble.py#L451-L453) and [v0_1_mcmc_verification_subset.py:148-150](analysis/scripts/v0_1_mcmc_verification_subset.py#L148-L150) but **not** propagated to either burst script. Grep across the repo finds these as the only two remaining instances.
...
- **File:** [v0_1_fuzz_missing_eds.py:54-59](analysis/scripts/v0_1_fuzz_missing_eds.py#L54-L59)
...
- **Description.** This script reimplements `efficiency_gap` instead of importing it from `seat_results`:
  ...
  ```
  The canonical implementation in [v0_1_mcmc_ensemble.py:154-157](analysis/scripts/v0_1_mcmc_ensemble.py#L154-L157) is:
  ```python
...
- **File:** [v0_1_mcmc_ensemble_250k_v0_8.py:248, 266-271](analysis/scripts/v0_1_mcmc_ensemble_250k_v0_8.py#L248-L271)
...
- **File:** [v0_1_mcmc_ensemble_250k_v0_8.py:120-130](analysis/scripts/v0_1_mcmc_ensemble_250k_v0_8.py#L120-L130)
...
- **File:** [v0_1_mcmc_ensemble.py:300](analysis/scripts/v0_1_mcmc_ensemble.py#L300)
...
- **Why it matters.** The audit's reproducibility promise — "any reader can recompute and confirm byte-for-byte" — is undercut whenever a v0_8 carve-out produces sliver overlaps. The fuzzing brief at [v0_1_fuzz_missing_eds.py](analysis/scripts/v0_1_fuzz_missing_eds.py) bounds the affected polygon count at 6 in the minority, so the magnitude is small, but the *kind* of non-determinism (different reviewer, different number) is exactly what reviewers complain about loudly when they catch it.
...
- **Files:**
  - [v0_1_targeted_gerrymander_burst.py:43](analysis/scripts/v0_1_targeted_gerrymander_burst.py#L43)
  - [v0_1_targeted_gerrymander_burst_ndp.py:41](analysis/scripts/v0_1_targeted_gerrymander_burst_ndp.py#L41)
...
- **File:** [v0_1_mcmc_ensemble.py:472-480](analysis/scripts/v0_1_mcmc_ensemble.py#L472-L480)
...
- **File:** [v0_1_mcmc_ensemble_250k_v0_8.py:253-255](analysis/scripts/v0_1_mcmc_ensemble_250k_v0_8.py#L253-L255)
...
- **Files:**
  - [v0_1_mcmc_ensemble.py:650](analysis/scripts/v0_1_mcmc_ensemble.py#L650)
  - [v0_1_mcmc_ensemble_100k.py:327](analysis/scripts/v0_1_mcmc_ensemble_100k.py#L327)
  - [v0_1_mcmc_ensemble_250k_v0_8.py:357](analysis/scripts/v0_1_mcmc_ensemble_250k_v0_8.py#L357)
...
- **File:** [v0_1_fuzz_missing_eds.py](analysis/scripts/v0_1_fuzz_missing_eds.py) — entire file
...
- **File:** [v0_1_fuzz_missing_eds.py:47](analysis/scripts/v0_1_fuzz_missing_eds.py#L47)
...
- **All ~50 non-priority scripts.** The brief listed 7 priority files; I read 8 (the seven plus `v0_1_mcmc_ensemble_100k.py` which exports `autocorrelation_ess`). Scripts I did NOT read include but are not limited to: `v0_1_chen_rodden_*.py`, `v0_1_compactness_metrics.py`, `v0_1_dpg_perfecter.py`, `v0_1_phase_4c_*.py`, `v0_1_extended_partisan_metrics.py`, `v0_1_marginal_seats_analysis.py`, `parse_2015_results.py`, `electoral_forensics_population.py`, the OCR / scraper utilities, and the article-figure builders. Bugs in those scripts would feed in to derived datasets but would not affect the four core formulas in `seat_results`.
