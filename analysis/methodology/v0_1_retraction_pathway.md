...
- **Retraction condition A.** Already narrowed under pre-commitment `v0_1_null_hypothesis_and_exoneration_criteria.md` §2.5: 3 of 4 metrics are INSIDE the 5–95 band, only seats@50/50 is outside. Claim currently reads "minority's drawing signature isolated to asymmetric-packing at 50/50 vote distribution."
