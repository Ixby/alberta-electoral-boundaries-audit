...
justification tests from `analysis/reports/v0_1_justification_tests_findings.md`
...
> `analysis/reports/v0_1_plan_b_cross_check.md` and the consolidated population
