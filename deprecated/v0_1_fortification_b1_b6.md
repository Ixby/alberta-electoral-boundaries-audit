...
backward_dependencies:
  ...
  - analysis/scripts/majority_symmetry_counter_test.py — new B3 counter-test script
...
**Defence 2 — The B3 counter-test was executed in `analysis/scripts/majority_symmetry_counter_test.py` (Track Q, 2026-04-22).** Results in `data/v0_1_majority_symmetry_counter_test.csv`. Two tests:
...
**F13 — New §3.12 (Symmetry-of-test-selection audit).** Insert the B3(iv) counter-test paragraph reporting the Edmonton and city-wide counter-test results. Reference `analysis/scripts/majority_symmetry_counter_test.py` and `data/v0_1_majority_symmetry_counter_test.csv`. Purpose: establish test-selection symmetry as an auditable discipline, contribute the Lethbridge and Red Deer findings.
...
**F17 — `analysis/scripts/majority_symmetry_counter_test.py` — authored and runnable.** Produces `data/v0_1_majority_symmetry_counter_test.csv`. Purpose: execute the B3 counter-test; contribute two new cracking-candidate findings (Lethbridge, Red Deer 4-way splits). Parent session commits.
...
- Symmetry counter-test: `analysis/scripts/majority_symmetry_counter_test.py` (this track) and `data/v0_1_majority_symmetry_counter_test.csv`
