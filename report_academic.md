...
**Reading B — Spatial against v0_8 full coverage (Layer 4, methods paper §5).** Used in §5.4.4 (Run #4, 250k MCMC, 4 chains). EG: majority **+6.43 %**, minority **+9.21 %** (both UCP-tail).
