...
forward_dependencies:
  - analysis/methodology/science_red_team_reproducibility_and_falsifiability.md (S3, S4, S5, S8)
  - analysis/methodology/science_red_team_data_priorart_peerreview.md (S6, S7, S10)
  - report_academic.md (findings in this file will be consumed before release sign-off)
backward_dependencies:
  - analysis/science_red_team_framework.md (dimension definitions, severity scale)
  - analysis/legal_red_team_framework.md (shared severity language, overlap points)
  - report_academic.md, analysis/methodology/mcmc_ensemble.md, analysis/reports/track_c_checklist_baseline_scoring.md, analysis/reports/pre_registration_draft.md, analysis/methodology/canadian_base_rate_computed.md, analysis/scripts/majority_symmetry_counter_test.py
