...
backward_dependencies:
  ...
  - report_academic.md, analysis/methodology/mcmc_ensemble.md, findings/checklist_baseline_scoring.md, analysis/reports/pre_registration_draft.md, analysis/methodology/canadian_base_rate_computed.md, analysis/scripts/majority_symmetry_counter_test.py
